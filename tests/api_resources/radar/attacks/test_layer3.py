...
class TestLayer3:
    ...
    def test_method_summary_v2(self, client: Cloudflare) -> None:
        layer3 = client.radar.attacks.layer3.summary_v2(
            dimension="PROTOCOL",
        )
        assert_matches_type(Layer3SummaryV2Response, layer3, path=["response"])
    ...
    def test_raw_response_summary_v2(self, client: Cloudflare) -> None:
        response = client.radar.attacks.layer3.with_raw_response.summary_v2(
            dimension="PROTOCOL",
        )
    ...
    def test_streaming_response_summary_v2(self, client: Cloudflare) -> None:
        with client.radar.attacks.layer3.with_streaming_response.summary_v2(
            dimension="PROTOCOL",
        ) as response:
    ...
    def test_method_timeseries_groups_v2(self, client: Cloudflare) -> None:
        layer3 = client.radar.attacks.layer3.timeseries_groups_v2(
            dimension="PROTOCOL",
        )
        assert_matches_type(Layer3TimeseriesGroupsV2Response, layer3, path=["response"])
    ...
    def test_raw_response_timeseries_groups_v2(self, client: Cloudflare) -> None:
        response = client.radar.attacks.layer3.with_raw_response.timeseries_groups_v2(
            dimension="PROTOCOL",
        )
    ...
    def test_streaming_response_timeseries_groups_v2(self, client: Cloudflare) -> None:
        with client.radar.attacks.layer3.with_streaming_response.timeseries_groups_v2(
            dimension="PROTOCOL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncLayer3:
    ...
    async def test_method_summary_v2(self, async_client: AsyncCloudflare) -> None:
        layer3 = await async_client.radar.attacks.layer3.summary_v2(
            dimension="PROTOCOL",
        )
        assert_matches_type(Layer3SummaryV2Response, layer3, path=["response"])
    ...
    async def test_raw_response_summary_v2(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.attacks.layer3.with_raw_response.summary_v2(
            dimension="PROTOCOL",
        )
    ...
    async def test_streaming_response_summary_v2(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.attacks.layer3.with_streaming_response.summary_v2(
            dimension="PROTOCOL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_timeseries_groups_v2(self, async_client: AsyncCloudflare) -> None:
        layer3 = await async_client.radar.attacks.layer3.timeseries_groups_v2(
            dimension="PROTOCOL",
        )
        assert_matches_type(Layer3TimeseriesGroupsV2Response, layer3, path=["response"])
    ...
    async def test_raw_response_timeseries_groups_v2(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.attacks.layer3.with_raw_response.timeseries_groups_v2(
            dimension="PROTOCOL",
        )
    ...
    async def test_streaming_response_timeseries_groups_v2(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.attacks.layer3.with_streaming_response.timeseries_groups_v2(
            dimension="PROTOCOL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
