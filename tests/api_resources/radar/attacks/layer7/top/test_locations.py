...
from cloudflare.types.radar.attacks.layer7.top import location_origin_params
from cloudflare.types.radar.attacks.layer7.top import location_target_params
