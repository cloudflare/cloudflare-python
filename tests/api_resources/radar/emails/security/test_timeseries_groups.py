...
class TestTimeseriesGroups:
    ...
    def test_method_dmarc(self, client: Cloudflare) -> None:
        timeseries_group = client.radar.emails.security.timeseries_groups.dmarc()
    ...
    def test_raw_response_dmarc(self, client: Cloudflare) -> None:
        response = client.radar.emails.security.timeseries_groups.with_raw_response.dmarc()
    ...
    def test_streaming_response_dmarc(self, client: Cloudflare) -> None:
        with client.radar.emails.security.timeseries_groups.with_streaming_response.dmarc() as response:
    ...
    def test_method_malicious(self, client: Cloudflare) -> None:
        timeseries_group = client.radar.emails.security.timeseries_groups.malicious()
    ...
    def test_raw_response_malicious(self, client: Cloudflare) -> None:
        response = client.radar.emails.security.timeseries_groups.with_raw_response.malicious()
    ...
    def test_streaming_response_malicious(self, client: Cloudflare) -> None:
        with client.radar.emails.security.timeseries_groups.with_streaming_response.malicious() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_spam(self, client: Cloudflare) -> None:
        timeseries_group = client.radar.emails.security.timeseries_groups.spam()
    ...
    def test_raw_response_spam(self, client: Cloudflare) -> None:
        response = client.radar.emails.security.timeseries_groups.with_raw_response.spam()
    ...
    def test_streaming_response_spam(self, client: Cloudflare) -> None:
        with client.radar.emails.security.timeseries_groups.with_streaming_response.spam() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_spf(self, client: Cloudflare) -> None:
        timeseries_group = client.radar.emails.security.timeseries_groups.spf()
    ...
    def test_raw_response_spf(self, client: Cloudflare) -> None:
        response = client.radar.emails.security.timeseries_groups.with_raw_response.spf()
    ...
    def test_streaming_response_spf(self, client: Cloudflare) -> None:
        with client.radar.emails.security.timeseries_groups.with_streaming_response.spf() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_threat_category(self, client: Cloudflare) -> None:
        timeseries_group = client.radar.emails.security.timeseries_groups.threat_category()
    ...
    def test_raw_response_threat_category(self, client: Cloudflare) -> None:
        response = client.radar.emails.security.timeseries_groups.with_raw_response.threat_category()
    ...
    def test_streaming_response_threat_category(self, client: Cloudflare) -> None:
        with client.radar.emails.security.timeseries_groups.with_streaming_response.threat_category() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncTimeseriesGroups:
    ...
    async def test_method_dmarc(self, async_client: AsyncCloudflare) -> None:
        timeseries_group = await async_client.radar.emails.security.timeseries_groups.dmarc()
        assert_matches_type(TimeseriesGroupDMARCResponse, timeseries_group, path=["response"])
    ...
    async def test_raw_response_dmarc(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.emails.security.timeseries_groups.with_raw_response.dmarc()
    ...
    async def test_streaming_response_dmarc(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.emails.security.timeseries_groups.with_streaming_response.dmarc() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_malicious(self, async_client: AsyncCloudflare) -> None:
        timeseries_group = await async_client.radar.emails.security.timeseries_groups.malicious()
        assert_matches_type(TimeseriesGroupMaliciousResponse, timeseries_group, path=["response"])
    ...
    async def test_raw_response_malicious(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.emails.security.timeseries_groups.with_raw_response.malicious()
    ...
    async def test_streaming_response_malicious(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.emails.security.timeseries_groups.with_streaming_response.malicious() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_spam(self, async_client: AsyncCloudflare) -> None:
        timeseries_group = await async_client.radar.emails.security.timeseries_groups.spam()
        assert_matches_type(TimeseriesGroupSpamResponse, timeseries_group, path=["response"])
    ...
    async def test_raw_response_spam(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.emails.security.timeseries_groups.with_raw_response.spam()
    ...
    async def test_streaming_response_spam(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.emails.security.timeseries_groups.with_streaming_response.spam() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_spf(self, async_client: AsyncCloudflare) -> None:
        timeseries_group = await async_client.radar.emails.security.timeseries_groups.spf()
        assert_matches_type(TimeseriesGroupSPFResponse, timeseries_group, path=["response"])
    ...
    async def test_raw_response_spf(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.emails.security.timeseries_groups.with_raw_response.spf()
    ...
    async def test_streaming_response_spf(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.emails.security.timeseries_groups.with_streaming_response.spf() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_threat_category(self, async_client: AsyncCloudflare) -> None:
        timeseries_group = await async_client.radar.emails.security.timeseries_groups.threat_category()
        assert_matches_type(TimeseriesGroupThreatCategoryResponse, timeseries_group, path=["response"])
    ...
    async def test_raw_response_threat_category(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.emails.security.timeseries_groups.with_raw_response.threat_category()
    ...
    async def test_streaming_response_threat_category(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.emails.security.timeseries_groups.with_streaming_response.threat_category() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
