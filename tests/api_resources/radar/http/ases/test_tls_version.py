...
from cloudflare.types.radar.http.ases import tls_version_get_params
...
class TestTLSVersion:
    ...
    def test_raw_response_get(self, client: Cloudflare) -> None:
        response = client.radar.http.ases.tls_version.with_raw_response.get(
            tls_version="TLSv1_0",
        )
    ...
    def test_streaming_response_get(self, client: Cloudflare) -> None:
        with client.radar.http.ases.tls_version.with_streaming_response.get(
            tls_version="TLSv1_0",
        ) as response:
...
class TestAsyncTLSVersion:
    ...
    async def test_raw_response_get(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.http.ases.tls_version.with_raw_response.get(
            tls_version="TLSv1_0",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.http.ases.tls_version.with_streaming_response.get(
            tls_version="TLSv1_0",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
