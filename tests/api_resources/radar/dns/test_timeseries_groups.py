...
from cloudflare.types.radar.dns import timeseries_group_cache_hit_params
from cloudflare.types.radar.dns import timeseries_group_dnssec_params
from cloudflare.types.radar.dns import timeseries_group_dnssec_aware_params
from cloudflare.types.radar.dns import timeseries_group_dnssec_e2e_params
from cloudflare.types.radar.dns import timeseries_group_ip_version_params
from cloudflare.types.radar.dns import timeseries_group_matching_answer_params
from cloudflare.types.radar.dns import timeseries_group_protocol_params
from cloudflare.types.radar.dns import timeseries_group_query_type_params
from cloudflare.types.radar.dns import timeseries_group_response_codes_params
from cloudflare.types.radar.dns import timeseries_group_response_ttl_params
...
class TestTimeseriesGroups:
    ...
    def test_raw_response_response_codes(self, client: Cloudflare) -> None:
        ...
        response = client.radar.dns.timeseries_groups.with_raw_response.response_codes()
    ...
    def test_streaming_response_response_codes(self, client: Cloudflare) -> None:
        with client.radar.dns.timeseries_groups.with_streaming_response.response_codes() as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
...
class TestAsyncTimeseriesGroups:
    ...
    async def test_raw_response_response_codes(self, async_client: AsyncCloudflare) -> None:
        ...
        response = await async_client.radar.dns.timeseries_groups.with_raw_response.response_codes()
    ...
    async def test_streaming_response_response_codes(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.dns.timeseries_groups.with_streaming_response.response_codes() as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
