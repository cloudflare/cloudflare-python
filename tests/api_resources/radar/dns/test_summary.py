...
from cloudflare.types.radar.dns import summary_cache_hit_params
from cloudflare.types.radar.dns import summary_dnssec_params
from cloudflare.types.radar.dns import summary_dnssec_aware_params
from cloudflare.types.radar.dns import summary_dnssec_e2e_params
from cloudflare.types.radar.dns import summary_ip_version_params
from cloudflare.types.radar.dns import summary_matching_answer_params
from cloudflare.types.radar.dns import summary_protocol_params
from cloudflare.types.radar.dns import summary_query_type_params
from cloudflare.types.radar.dns import summary_response_codes_params
...
class TestSummary:
    ...
    def test_method_response_codes(self, client: Cloudflare) -> None:
        summary = client.radar.dns.summary.response_codes()
    ...
    def test_raw_response_response_codes(self, client: Cloudflare) -> None:
        ...
        response = client.radar.dns.summary.with_raw_response.response_codes()
    ...
    def test_streaming_response_response_codes(self, client: Cloudflare) -> None:
        with client.radar.dns.summary.with_streaming_response.response_codes() as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
...
class TestAsyncSummary:
    ...
    async def test_method_response_codes(self, async_client: AsyncCloudflare) -> None:
        summary = await async_client.radar.dns.summary.response_codes()
        assert_matches_type(SummaryResponseCodesResponse, summary, path=['response'])
    ...
    async def test_raw_response_response_codes(self, async_client: AsyncCloudflare) -> None:
        ...
        response = await async_client.radar.dns.summary.with_raw_response.response_codes()
    ...
    async def test_streaming_response_response_codes(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.dns.summary.with_streaming_response.response_codes() as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
