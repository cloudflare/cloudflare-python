...
class TestInference:
    ...
    def test_method_summary_v2(self, client: Cloudflare) -> None:
        inference = client.radar.ai.inference.summary_v2(
            dimension="MODEL",
        )
        assert_matches_type(InferenceSummaryV2Response, inference, path=["response"])
    ...
    def test_raw_response_summary_v2(self, client: Cloudflare) -> None:
        response = client.radar.ai.inference.with_raw_response.summary_v2(
            dimension="MODEL",
        )
    ...
    def test_streaming_response_summary_v2(self, client: Cloudflare) -> None:
        with client.radar.ai.inference.with_streaming_response.summary_v2(
            dimension="MODEL",
        ) as response:
    ...
    def test_method_timeseries_groups_v2(self, client: Cloudflare) -> None:
        inference = client.radar.ai.inference.timeseries_groups_v2(
            dimension="MODEL",
        )
    ...
    def test_raw_response_timeseries_groups_v2(self, client: Cloudflare) -> None:
        response = client.radar.ai.inference.with_raw_response.timeseries_groups_v2(
            dimension="MODEL",
        )
    ...
    def test_streaming_response_timeseries_groups_v2(self, client: Cloudflare) -> None:
        with client.radar.ai.inference.with_streaming_response.timeseries_groups_v2(
            dimension="MODEL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncInference:
    ...
    async def test_method_summary_v2(self, async_client: AsyncCloudflare) -> None:
        inference = await async_client.radar.ai.inference.summary_v2(
            dimension="MODEL",
        )
        assert_matches_type(InferenceSummaryV2Response, inference, path=["response"])
    ...
    async def test_raw_response_summary_v2(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.ai.inference.with_raw_response.summary_v2(
            dimension="MODEL",
        )
    ...
    async def test_streaming_response_summary_v2(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.ai.inference.with_streaming_response.summary_v2(
            dimension="MODEL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_timeseries_groups_v2(self, async_client: AsyncCloudflare) -> None:
        inference = await async_client.radar.ai.inference.timeseries_groups_v2(
            dimension="MODEL",
        )
        assert_matches_type(InferenceTimeseriesGroupsV2Response, inference, path=["response"])
    ...
    async def test_raw_response_timeseries_groups_v2(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.radar.ai.inference.with_raw_response.timeseries_groups_v2(
            dimension="MODEL",
        )
    ...
    async def test_streaming_response_timeseries_groups_v2(self, async_client: AsyncCloudflare) -> None:
        async with async_client.radar.ai.inference.with_streaming_response.timeseries_groups_v2(
            dimension="MODEL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
