...
from cloudflare.types.workers_for_platforms.dispatch.namespaces.scripts import TagUpdateResponse, TagListResponse
...
from cloudflare.types.workers_for_platforms.dispatch.namespaces.scripts import tag_update_params
