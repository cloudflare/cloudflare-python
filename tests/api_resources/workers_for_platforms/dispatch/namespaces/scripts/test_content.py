...
from cloudflare.types.workers_for_platforms.dispatch.namespaces.scripts import content_update_params
...
class TestContent:
    ...
    def test_method_get(self, client: Cloudflare, respx_mock: MockRouter) -> None:
        respx_mock.get('/accounts/023e105f4ecef8ad9ca31a8372d0c353/workers/dispatch/namespaces/my-dispatch-namespace/scripts/this-is_my_script-01/content').mock(
...
class TestAsyncContent:
    ...
    async def test_raw_response_update(self, async_client: AsyncCloudflare) -> None:
        ...
        response = await async_client.workers_for_platforms.dispatch.namespaces.scripts.content.with_raw_response.update(
            script_name="this-is_my_script-01",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
            dispatch_namespace="my-dispatch-namespace",
        )
