...
class TestPrefixes:
    ...
    def test_method_validate(self, client: Cloudflare) -> None:
        prefix = client.addressing.prefixes.validate(
            prefix_id="2af39739cc4e3b5910c918468bb89828",
            account_id="258def64c72dae45f3e4c8516e2111f2",
        )
        assert_matches_type(Optional[Prefix], prefix, path=["response"])
    ...
    def test_raw_response_validate(self, client: Cloudflare) -> None:
        response = client.addressing.prefixes.with_raw_response.validate(
            prefix_id="2af39739cc4e3b5910c918468bb89828",
            account_id="258def64c72dae45f3e4c8516e2111f2",
        )
    ...
    def test_streaming_response_validate(self, client: Cloudflare) -> None:
        with client.addressing.prefixes.with_streaming_response.validate(
            prefix_id="2af39739cc4e3b5910c918468bb89828",
            account_id="258def64c72dae45f3e4c8516e2111f2",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_validate(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.addressing.prefixes.with_raw_response.validate(
                prefix_id="2af39739cc4e3b5910c918468bb89828",
                account_id="",
            )
...
class TestAsyncPrefixes:
    ...
    async def test_method_validate(self, async_client: AsyncCloudflare) -> None:
        prefix = await async_client.addressing.prefixes.validate(
            prefix_id="2af39739cc4e3b5910c918468bb89828",
            account_id="258def64c72dae45f3e4c8516e2111f2",
        )
        assert_matches_type(Optional[Prefix], prefix, path=["response"])
    ...
    async def test_raw_response_validate(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.addressing.prefixes.with_raw_response.validate(
            prefix_id="2af39739cc4e3b5910c918468bb89828",
            account_id="258def64c72dae45f3e4c8516e2111f2",
        )
    ...
    async def test_streaming_response_validate(self, async_client: AsyncCloudflare) -> None:
        async with async_client.addressing.prefixes.with_streaming_response.validate(
            prefix_id="2af39739cc4e3b5910c918468bb89828",
            account_id="258def64c72dae45f3e4c8516e2111f2",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_validate(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.addressing.prefixes.with_raw_response.validate(
                prefix_id="2af39739cc4e3b5910c918468bb89828",
                account_id="",
            )
