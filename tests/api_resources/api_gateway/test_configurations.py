...
from cloudflare.types.api_gateway import ConfigurationUpdateResponse, Configuration
...
from cloudflare.types.api_gateway import configuration_update_params
from cloudflare.types.api_gateway import configuration_get_params
