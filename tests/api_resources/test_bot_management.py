...
from cloudflare.types.bot_management import BotManagementUpdateResponse, BotManagementGetResponse
...
from cloudflare.types.bot_management import bot_management_update_params
