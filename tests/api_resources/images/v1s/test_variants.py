...
from cloudflare.types.images.v1s import variant_update_params
from cloudflare.types.images.v1s import variant_cloudflare_images_variants_create_a_variant_params
