...
from cloudflare.types.logpush import edge_update_params
...
class TestEdges:
    ...
    def test_raw_response_get(self, client: Cloudflare) -> None:
        response = client.logpush.edges.with_raw_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_streaming_response_get(self, client: Cloudflare) -> None:
        with client.logpush.edges.with_streaming_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.logpush.edges.with_raw_response.get(
                "",
            )
...
class TestAsyncEdges:
    ...
    async def test_method_get(self, async_client: AsyncCloudflare) -> None:
        edge = await async_client.logpush.edges.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(EdgeGetResponse, edge, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.logpush.edges.with_raw_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCloudflare) -> None:
        async with async_client.logpush.edges.with_streaming_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.logpush.edges.with_raw_response.get(
                "",
            )
