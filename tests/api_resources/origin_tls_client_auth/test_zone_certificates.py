...
class TestZoneCertificates:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_create(self, client: Cloudflare) -> None:
        zone_certificate = client.origin_tls_client_auth.zone_certificates.create(
        ...
        assert_matches_type(Optional[ZoneCertificateCreateResponse], zone_certificate, path=["response"])

    @parametrize
    def test_raw_response_create(self, client: Cloudflare) -> None:
        response = client.origin_tls_client_auth.zone_certificates.with_raw_response.create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
            private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
        )
        ...
        zone_certificate = response.parse()
        assert_matches_type(Optional[ZoneCertificateCreateResponse], zone_certificate, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: Cloudflare) -> None:
        with client.origin_tls_client_auth.zone_certificates.with_streaming_response.create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
            private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
        ) as response:
    ...
    def test_path_params_create(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.origin_tls_client_auth.zone_certificates.with_raw_response.create(
                zone_id="",
                certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
                private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
            )
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        zone_certificate = client.origin_tls_client_auth.zone_certificates.list(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(SyncSinglePage[ZoneCertificateListResponse], zone_certificate, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Cloudflare) -> None:
        response = client.origin_tls_client_auth.zone_certificates.with_raw_response.list(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.origin_tls_client_auth.zone_certificates.with_streaming_response.list(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.origin_tls_client_auth.zone_certificates.with_raw_response.list(
                zone_id="",
            )
...
class TestAsyncZoneCertificates:
    ...
    async def test_method_create(self, async_client: AsyncCloudflare) -> None:
        zone_certificate = await async_client.origin_tls_client_auth.zone_certificates.create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
            private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.origin_tls_client_auth.zone_certificates.with_raw_response.create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
            private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        zone_certificate = await response.parse()
        assert_matches_type(Optional[ZoneCertificateCreateResponse], zone_certificate, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncCloudflare) -> None:
        async with async_client.origin_tls_client_auth.zone_certificates.with_streaming_response.create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
            private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
        ) as response:
    ...
    async def test_path_params_create(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.origin_tls_client_auth.zone_certificates.with_raw_response.create(
                zone_id="",
                certificate="-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
                private_key="-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n",
            )
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        zone_certificate = await async_client.origin_tls_client_auth.zone_certificates.list(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(AsyncSinglePage[ZoneCertificateListResponse], zone_certificate, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.origin_tls_client_auth.zone_certificates.with_raw_response.list(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.origin_tls_client_auth.zone_certificates.with_streaming_response.list(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.origin_tls_client_auth.zone_certificates.with_raw_response.list(
                zone_id="",
            )
