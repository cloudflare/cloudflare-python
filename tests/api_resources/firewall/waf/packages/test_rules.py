...
from cloudflare.types.firewall.waf.packages import RuleListResponse, RuleEditResponse, RuleGetResponse
...
from cloudflare.types.firewall.waf.packages import rule_list_params
from cloudflare.types.firewall.waf.packages import rule_edit_params
