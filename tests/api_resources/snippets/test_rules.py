...
class TestRules:
    ...
    def test_path_params_delete(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.snippets.rules.with_raw_response.delete(
                zone_id="",
            )

    @parametrize
    def test_method_get(self, client: Cloudflare) -> None:
        rule = client.snippets.rules.get(
            zone_id="9f1839b6152d298aca64c4e906b6d074",
        )
        assert_matches_type(object, rule, path=["response"])
    ...
    def test_raw_response_get(self, client: Cloudflare) -> None:
        response = client.snippets.rules.with_raw_response.get(
            zone_id="9f1839b6152d298aca64c4e906b6d074",
        )
    ...
    def test_streaming_response_get(self, client: Cloudflare) -> None:
        with client.snippets.rules.with_streaming_response.get(
            zone_id="9f1839b6152d298aca64c4e906b6d074",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.snippets.rules.with_raw_response.get(
                zone_id="",
            )
...
class TestAsyncRules:
    ...
    async def test_path_params_delete(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.snippets.rules.with_raw_response.delete(
                zone_id="",
            )

    @parametrize
    async def test_method_get(self, async_client: AsyncCloudflare) -> None:
        rule = await async_client.snippets.rules.get(
            zone_id="9f1839b6152d298aca64c4e906b6d074",
        )
        assert_matches_type(object, rule, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.snippets.rules.with_raw_response.get(
            zone_id="9f1839b6152d298aca64c4e906b6d074",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCloudflare) -> None:
        async with async_client.snippets.rules.with_streaming_response.get(
            zone_id="9f1839b6152d298aca64c4e906b6d074",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.snippets.rules.with_raw_response.get(
                zone_id="",
            )
