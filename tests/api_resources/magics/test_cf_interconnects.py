...
class TestCfInterconnects:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        cf_interconnect = client.magics.cf_interconnects.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_raw_response_list(self, client: Cloudflare) -> None:
        response = client.magics.cf_interconnects.with_raw_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.magics.cf_interconnects.with_streaming_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_identifier` but received ''"):
            client.magics.cf_interconnects.with_raw_response.list(
                "",
            )
...
class TestAsyncCfInterconnects:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        cf_interconnect = await async_client.magics.cf_interconnects.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(CfInterconnectListResponse, cf_interconnect, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.magics.cf_interconnects.with_raw_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.magics.cf_interconnects.with_streaming_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_identifier` but received ''"):
            await async_client.magics.cf_interconnects.with_raw_response.list(
                "",
            )
