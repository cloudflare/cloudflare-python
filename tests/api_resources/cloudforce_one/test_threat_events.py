...
class TestThreatEvents:
    ...
    def test_method_update(self, client: Cloudflare) -> None:
        threat_event = client.cloudforce_one.threat_events.update(
            event_id="eventId",
            account_id=0,
        )
        assert_matches_type(ThreatEventUpdateResponse, threat_event, path=["response"])
    ...
    def test_raw_response_update(self, client: Cloudflare) -> None:
        response = client.cloudforce_one.threat_events.with_raw_response.update(
            event_id="eventId",
            account_id=0,
        )
    ...
    def test_streaming_response_update(self, client: Cloudflare) -> None:
        with client.cloudforce_one.threat_events.with_streaming_response.update(
            event_id="eventId",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_id` but received ''"):
            client.cloudforce_one.threat_events.with_raw_response.update(
                event_id="",
                account_id=0,
            )
...
class TestAsyncThreatEvents:
    ...
    async def test_method_update(self, async_client: AsyncCloudflare) -> None:
        threat_event = await async_client.cloudforce_one.threat_events.update(
            event_id="eventId",
            account_id=0,
        )
        assert_matches_type(ThreatEventUpdateResponse, threat_event, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.cloudforce_one.threat_events.with_raw_response.update(
            event_id="eventId",
            account_id=0,
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCloudflare) -> None:
        async with async_client.cloudforce_one.threat_events.with_streaming_response.update(
            event_id="eventId",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_id` but received ''"):
            await async_client.cloudforce_one.threat_events.with_raw_response.update(
                event_id="",
                account_id=0,
            )
