...
class TestRelate:
    ...
    def test_method_update(self, client: Cloudflare) -> None:
        relate = client.cloudforce_one.threat_events.relate.update(
            event_id="eventId",
            account_id=0,
            events=["88888888-4444-4444-4444-121212121212"],
        )
        assert_matches_type(RelateUpdateResponse, relate, path=["response"])

    @parametrize
    def test_raw_response_update(self, client: Cloudflare) -> None:
        response = client.cloudforce_one.threat_events.relate.with_raw_response.update(
            event_id="eventId",
            account_id=0,
            events=["88888888-4444-4444-4444-121212121212"],
        )
    ...
    def test_streaming_response_update(self, client: Cloudflare) -> None:
        with client.cloudforce_one.threat_events.relate.with_streaming_response.update(
            event_id="eventId",
            account_id=0,
            events=["88888888-4444-4444-4444-121212121212"],
        ) as response:
    ...
    def test_path_params_update(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_id` but received ''"):
            client.cloudforce_one.threat_events.relate.with_raw_response.update(
                event_id="",
                account_id=0,
                events=["88888888-4444-4444-4444-121212121212"],
            )
...
class TestAsyncRelate:
    ...
    async def test_method_update(self, async_client: AsyncCloudflare) -> None:
        relate = await async_client.cloudforce_one.threat_events.relate.update(
            event_id="eventId",
            account_id=0,
            events=["88888888-4444-4444-4444-121212121212"],
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.cloudforce_one.threat_events.relate.with_raw_response.update(
            event_id="eventId",
            account_id=0,
            events=["88888888-4444-4444-4444-121212121212"],
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCloudflare) -> None:
        async with async_client.cloudforce_one.threat_events.relate.with_streaming_response.update(
            event_id="eventId",
            account_id=0,
            events=["88888888-4444-4444-4444-121212121212"],
        ) as response:
    ...
    async def test_path_params_update(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_id` but received ''"):
            await async_client.cloudforce_one.threat_events.relate.with_raw_response.update(
                event_id="",
                account_id=0,
                events=["88888888-4444-4444-4444-121212121212"],
            )
