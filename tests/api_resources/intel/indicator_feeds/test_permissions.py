...
from cloudflare.types.intel.indicator_feeds import permission_create_params
from cloudflare.types.intel.indicator_feeds import permission_delete_params
