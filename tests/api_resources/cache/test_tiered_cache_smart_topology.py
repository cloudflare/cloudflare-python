...
class TestTieredCacheSmartTopology:
    ...
    def test_raw_response_delete(self, client: Cloudflare) -> None:
        ...
        tiered_cache_smart_topology = response.parse()
        assert_matches_type(TieredCacheSmartTopologyDeleteResponse, tiered_cache_smart_topology, path=["response"])
...
class TestAsyncTieredCacheSmartTopology:
    ...
    async def test_raw_response_delete(self, async_client: AsyncCloudflare) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        tiered_cache_smart_topology = await response.parse()
        assert_matches_type(TieredCacheSmartTopologyDeleteResponse, tiered_cache_smart_topology, path=["response"])
