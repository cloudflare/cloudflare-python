...
from cloudflare.types.users.load_balancers import monitor_create_params
...
class TestMonitors:
    ...
    def test_method_create(self, client: Cloudflare) -> None:
        monitor = client.users.load_balancers.monitors.create(
            expected_codes="2xx",
        )
    ...
    def test_raw_response_create(self, client: Cloudflare) -> None:
        response = client.users.load_balancers.monitors.with_raw_response.create(
            expected_codes="2xx",
        )
    ...
    def test_streaming_response_create(self, client: Cloudflare) -> None:
        with client.users.load_balancers.monitors.with_streaming_response.create(
            expected_codes="2xx",
        ) as response:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        monitor = client.users.load_balancers.monitors.list()
        assert_matches_type(Optional[MonitorListResponse], monitor, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list(self, client: Cloudflare) -> None:
        response = client.users.load_balancers.monitors.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.users.load_balancers.monitors.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncMonitors:
    ...
    async def test_method_create(self, async_client: AsyncCloudflare) -> None:
        monitor = await async_client.users.load_balancers.monitors.create(
            expected_codes="2xx",
        )
        assert_matches_type(MonitorCreateResponse, monitor, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.users.load_balancers.monitors.with_raw_response.create(
            expected_codes="2xx",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncCloudflare) -> None:
        async with async_client.users.load_balancers.monitors.with_streaming_response.create(
            expected_codes="2xx",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        monitor = await async_client.users.load_balancers.monitors.list()
        assert_matches_type(Optional[MonitorListResponse], monitor, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.users.load_balancers.monitors.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.users.load_balancers.monitors.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
