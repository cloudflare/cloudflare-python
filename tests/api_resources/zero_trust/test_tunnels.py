...
class TestTunnels:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(SyncV4PagePaginationArray[UnnamedSchemaRef123], tunnel, path=["response"])
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(UnnamedSchemaRef123, tunnel, path=["response"])
...
class TestAsyncTunnels:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        ...
        assert_matches_type(AsyncV4PagePaginationArray[UnnamedSchemaRef123], tunnel, path=["response"])
