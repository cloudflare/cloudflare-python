...
class TestPredefined:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        predefined = client.zero_trust.dlp.entries.predefined.list(
            account_id="account_id",
        )
        assert_matches_type(SyncSinglePage[PredefinedListResponse], predefined, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Cloudflare) -> None:
        response = client.zero_trust.dlp.entries.predefined.with_raw_response.list(
            account_id="account_id",
        )
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.zero_trust.dlp.entries.predefined.with_streaming_response.list(
            account_id="account_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.zero_trust.dlp.entries.predefined.with_raw_response.list(
                account_id="",
            )
    ...
    def test_method_get(self, client: Cloudflare) -> None:
        predefined = client.zero_trust.dlp.entries.predefined.get(
            entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id="account_id",
        )
        assert_matches_type(Optional[PredefinedGetResponse], predefined, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Cloudflare) -> None:
        response = client.zero_trust.dlp.entries.predefined.with_raw_response.get(
            entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id="account_id",
        )
    ...
    def test_streaming_response_get(self, client: Cloudflare) -> None:
        with client.zero_trust.dlp.entries.predefined.with_streaming_response.get(
            entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id="account_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.zero_trust.dlp.entries.predefined.with_raw_response.get(
                entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                account_id="",
            )
...
class TestAsyncPredefined:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        predefined = await async_client.zero_trust.dlp.entries.predefined.list(
            account_id="account_id",
        )
        assert_matches_type(AsyncSinglePage[PredefinedListResponse], predefined, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.zero_trust.dlp.entries.predefined.with_raw_response.list(
            account_id="account_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.zero_trust.dlp.entries.predefined.with_streaming_response.list(
            account_id="account_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.zero_trust.dlp.entries.predefined.with_raw_response.list(
                account_id="",
            )
    ...
    async def test_method_get(self, async_client: AsyncCloudflare) -> None:
        predefined = await async_client.zero_trust.dlp.entries.predefined.get(
            entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id="account_id",
        )
        assert_matches_type(Optional[PredefinedGetResponse], predefined, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.zero_trust.dlp.entries.predefined.with_raw_response.get(
            entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id="account_id",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCloudflare) -> None:
        async with async_client.zero_trust.dlp.entries.predefined.with_streaming_response.get(
            entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id="account_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.zero_trust.dlp.entries.predefined.with_raw_response.get(
                entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                account_id="",
            )
