...
from cloudflare.types.zero_trust.devices import unrevoke_create_params
...
class TestUnrevoke:
    ...
    def test_method_create(self, client: Cloudflare) -> None:
        unrevoke = client.zero_trust.devices.unrevoke.create(
            ...
            body=["f174e90a-fafe-4643-bbbc-4a0ed4fc8415", "f174e90a-fafe-4643-bbbc-4a0ed4fc8415", "f174e90a-fafe-4643-bbbc-4a0ed4fc8415"],
        )
