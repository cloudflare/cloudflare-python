...
from cloudflare.types.zero_trust.devices.posture import integration_create_params
from cloudflare.types.zero_trust.devices.posture import integration_edit_params
