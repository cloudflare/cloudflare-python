...
from cloudflare.types.zero_trust.access.certificates import SettingUpdateResponse, SettingGetResponse
...
from cloudflare.types.zero_trust.access.certificates import setting_update_params
