...
class TestApplications:
    ...
    def test_method_create_with_all_params_overload_1(self, client: Cloudflare) -> None:
        application = client.zero_trust.access.applications.create(
            ...
            destinations=[
                {
                    "destination": "test.example.com/admin",
                    "type": "public",
                },
                {
                    "destination": "test.anotherexample.com/staff",
                    "type": "public",
                },
                {
                    "destination": "10.5.0.2",
                    "type": "public",
                },
                {
                    "destination": "10.5.0.3/32:1234-4321",
                    "type": "public",
                },
                {
                    "destination": "private-sni.example.com",
                    "type": "public",
                },
            ],
