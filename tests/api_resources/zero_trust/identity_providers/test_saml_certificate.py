...
class TestSAMLCertificate:
    ...
    def test_path_params_create(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.zero_trust.identity_providers.saml_certificate.with_raw_response.create(
                identity_provider_id="f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
                account_id="",
            )
...
class TestAsyncSAMLCertificate:
    ...
    async def test_path_params_create(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.zero_trust.identity_providers.saml_certificate.with_raw_response.create(
                identity_provider_id="f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
                account_id="",
            )
