...
class TestConnections:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(SyncSinglePage[ConnectionListResponse], connection, path=["response"])
...
class TestAsyncConnections:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        ...
        assert_matches_type(AsyncSinglePage[ConnectionListResponse], connection, path=["response"])
