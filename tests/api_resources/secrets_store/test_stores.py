...
class TestStores:
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.secrets_store.stores.with_raw_response.list(
                account_id="",
            )
    ...
    def test_path_params_delete(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.secrets_store.stores.with_raw_response.delete(
                store_id="023e105f4ecef8ad9ca31a8372d0c353",
                account_id="",
            )
...
class TestAsyncStores:
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.secrets_store.stores.with_raw_response.list(
                account_id="",
            )
    ...
    async def test_path_params_delete(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.secrets_store.stores.with_raw_response.delete(
                store_id="023e105f4ecef8ad9ca31a8372d0c353",
                account_id="",
            )
