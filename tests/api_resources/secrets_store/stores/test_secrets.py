...
class TestSecrets:
    ...
    @parametrize
    def test_method_bulkd_edit(self, client: Cloudflare) -> None:
        secret = client.secrets_store.stores.secrets.bulkd_edit(
            store_id="023e105f4ecef8ad9ca31a8372d0c353",
            account_id="985e105f4ecef8ad9ca31a8372d0c353",
            body=[{"name": "MY_API_KEY"}],
        )
        assert_matches_type(SyncSinglePage[SecretBulkdEditResponse], secret, path=["response"])

    @parametrize
    def test_raw_response_bulkd_edit(self, client: Cloudflare) -> None:
        response = client.secrets_store.stores.secrets.with_raw_response.bulkd_edit(
            store_id="023e105f4ecef8ad9ca31a8372d0c353",
            account_id="985e105f4ecef8ad9ca31a8372d0c353",
            body=[{"name": "MY_API_KEY"}],
        )
    ...
    @parametrize
    def test_streaming_response_bulkd_edit(self, client: Cloudflare) -> None:
        with client.secrets_store.stores.secrets.with_streaming_response.bulkd_edit(
            store_id="023e105f4ecef8ad9ca31a8372d0c353",
            account_id="985e105f4ecef8ad9ca31a8372d0c353",
            body=[{"name": "MY_API_KEY"}],
        ) as response:
    ...
    @parametrize
    def test_path_params_bulkd_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.secrets_store.stores.secrets.with_raw_response.bulkd_edit(
                store_id="023e105f4ecef8ad9ca31a8372d0c353",
                account_id="",
                body=[{"name": "MY_API_KEY"}],
            )
...
class TestAsyncSecrets:
    ...
    @parametrize
    async def test_method_bulkd_edit(self, async_client: AsyncCloudflare) -> None:
        secret = await async_client.secrets_store.stores.secrets.bulkd_edit(
            store_id="023e105f4ecef8ad9ca31a8372d0c353",
            account_id="985e105f4ecef8ad9ca31a8372d0c353",
            body=[{"name": "MY_API_KEY"}],
        )
        assert_matches_type(AsyncSinglePage[SecretBulkdEditResponse], secret, path=["response"])

    @parametrize
    async def test_raw_response_bulkd_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.secrets_store.stores.secrets.with_raw_response.bulkd_edit(
            store_id="023e105f4ecef8ad9ca31a8372d0c353",
            account_id="985e105f4ecef8ad9ca31a8372d0c353",
            body=[{"name": "MY_API_KEY"}],
        )
    ...
    @parametrize
    async def test_streaming_response_bulkd_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.secrets_store.stores.secrets.with_streaming_response.bulkd_edit(
            store_id="023e105f4ecef8ad9ca31a8372d0c353",
            account_id="985e105f4ecef8ad9ca31a8372d0c353",
            body=[{"name": "MY_API_KEY"}],
        ) as response:
    ...
    @parametrize
    async def test_path_params_bulkd_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.secrets_store.stores.secrets.with_raw_response.bulkd_edit(
                store_id="023e105f4ecef8ad9ca31a8372d0c353",
                account_id="",
                body=[{"name": "MY_API_KEY"}],
            )
