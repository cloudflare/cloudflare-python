...
class TestZones:
    ...
    def test_method_create(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(Optional[ZonesZone], zone, path=["response"])
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(SyncV4PagePaginationArray[ZonesZone], zone, path=["response"])
...
class TestAsyncZones:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        ...
        assert_matches_type(AsyncV4PagePaginationArray[ZonesZone], zone, path=["response"])
