...
from cloudflare.types.ssl.universal import SettingGetResponse, SettingEditResponse
...
class TestSettings:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.ssl.universal.settings.with_raw_response.edit(
                "",
            )
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.ssl.universal.settings.with_raw_response.get(
                "",
            )
...
class TestAsyncSettings:
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.ssl.universal.settings.with_raw_response.edit(
                "",
            )
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.ssl.universal.settings.with_raw_response.get(
                "",
            )
