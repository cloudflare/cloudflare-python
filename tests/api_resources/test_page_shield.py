...
from cloudflare.types.page_shield import PageShieldGetResponse, PageShieldUpdateResponse
...
class TestPageShield:
    ...
    def test_method_get(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(Optional[PageShieldGetResponse], page_shield, path=["response"])
