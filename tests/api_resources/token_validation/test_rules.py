...
class TestRules:
    ...
    def test_method_bulk_create(self, client: Cloudflare) -> None:
        rule = client.token_validation.rules.bulk_create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[
                {
                    "action": "log",
        ...
        assert_matches_type(SyncSinglePage[TokenValidationRule], rule, path=["response"])

    @parametrize
    def test_raw_response_bulk_create(self, client: Cloudflare) -> None:
        response = client.token_validation.rules.with_raw_response.bulk_create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[
                {
                    "action": "log",
    ...
    def test_streaming_response_bulk_create(self, client: Cloudflare) -> None:
        with client.token_validation.rules.with_streaming_response.bulk_create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[
                {
                    "action": "log",
    ...
    def test_path_params_bulk_create(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.token_validation.rules.with_raw_response.bulk_create(
                zone_id="",
                body=[
                    {
                        "action": "log",
    ...
    def test_method_bulk_edit(self, client: Cloudflare) -> None:
        rule = client.token_validation.rules.bulk_edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    def test_raw_response_bulk_edit(self, client: Cloudflare) -> None:
        response = client.token_validation.rules.with_raw_response.bulk_edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
        )
    ...
    def test_streaming_response_bulk_edit(self, client: Cloudflare) -> None:
        with client.token_validation.rules.with_streaming_response.bulk_edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_bulk_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.token_validation.rules.with_raw_response.bulk_edit(
                zone_id="",
                body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
            )
...
class TestAsyncRules:
    ...
    async def test_method_bulk_create(self, async_client: AsyncCloudflare) -> None:
        rule = await async_client.token_validation.rules.bulk_create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[
                {
                    "action": "log",
        ...
        assert_matches_type(AsyncSinglePage[TokenValidationRule], rule, path=["response"])

    @parametrize
    async def test_raw_response_bulk_create(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.token_validation.rules.with_raw_response.bulk_create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[
                {
                    "action": "log",
    ...
    async def test_streaming_response_bulk_create(self, async_client: AsyncCloudflare) -> None:
        async with async_client.token_validation.rules.with_streaming_response.bulk_create(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[
                {
                    "action": "log",
    ...
    async def test_path_params_bulk_create(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.token_validation.rules.with_raw_response.bulk_create(
                zone_id="",
                body=[
                    {
                        "action": "log",
    ...
    async def test_method_bulk_edit(self, async_client: AsyncCloudflare) -> None:
        rule = await async_client.token_validation.rules.bulk_edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
        )
        assert_matches_type(AsyncSinglePage[TokenValidationRule], rule, path=["response"])
    ...
    async def test_raw_response_bulk_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.token_validation.rules.with_raw_response.bulk_edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
        )
    ...
    async def test_streaming_response_bulk_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.token_validation.rules.with_streaming_response.bulk_edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_bulk_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.token_validation.rules.with_raw_response.bulk_edit(
                zone_id="",
                body=[{"id": "0d9bf70c-92e1-4bb3-9411-34a3bcc59003"}],
            )
