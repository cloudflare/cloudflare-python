...
class TestFilters:
    ...
    def test_method_update(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(Filter, filter, path=["response"])
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(SyncV4PagePaginationArray[Filter], filter, path=["response"])
...
class TestAsyncFilters:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        ...
        assert_matches_type(AsyncV4PagePaginationArray[Filter], filter, path=["response"])
