...
class TestOriginCACertificates:
    ...
    def test_method_delete(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(UnnamedSchemaRef8900f4cb9dca9b9ed0ac41ad571e6837, origin_ca_certificate, path=["response"])
    ...
    def test_streaming_response_delete(self, client: Cloudflare) -> None:
        with client.origin_ca_certificates.with_streaming_response.delete(
            ...
            origin_ca_certificate = response.parse()
            assert_matches_type(
                UnnamedSchemaRef8900f4cb9dca9b9ed0ac41ad571e6837, origin_ca_certificate, path=["response"]
            )
