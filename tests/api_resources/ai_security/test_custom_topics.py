...
from cloudflare.types.ai_security import CustomTopicGetResponse, CustomTopicUpdateResponse
...
class TestCustomTopics:
    ...
    def test_path_params_update(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.ai_security.custom_topics.with_raw_response.update(
                zone_id="",
            )
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.ai_security.custom_topics.with_raw_response.get(
                zone_id="",
            )


class TestAsyncCustomTopics:
    ...
    async def test_path_params_update(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.ai_security.custom_topics.with_raw_response.update(
                zone_id="",
            )
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.ai_security.custom_topics.with_raw_response.get(
                zone_id="",
            )
