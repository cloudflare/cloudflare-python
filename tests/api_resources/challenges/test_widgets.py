...
class TestWidgets:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(SyncV4PagePaginationArray[WidgetDomain], widget, path=["response"])
...
class TestAsyncWidgets:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        ...
        assert_matches_type(AsyncV4PagePaginationArray[WidgetDomain], widget, path=["response"])
