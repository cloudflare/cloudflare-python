...
class TestMTLSCertificates:
    ...
    def test_method_create(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(TLSCertificatesAndHostnamesCertificateObjectPost, mtls_certificate, path=["response"])
    ...
    def test_method_delete(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(
            TLSCertificatesAndHostnamesComponentsSchemasCertificateObject, mtls_certificate, path=["response"]
        )
