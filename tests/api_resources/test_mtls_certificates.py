...
from cloudflare.types import mtls_certificate_update_params
...
class TestMtlsCertificates:
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.mtls_certificates.with_streaming_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.mtls_certificates.with_raw_response.list(
                "",
            )
    ...
    def test_method_delete(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(MtlsCertificateDeleteResponse, mtls_certificate, path=["response"])
    ...
    def test_method_get(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(MtlsCertificateGetResponse, mtls_certificate, path=["response"])
...
class TestAsyncMtlsCertificates:
    ...
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.mtls_certificates.with_raw_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.mtls_certificates.with_streaming_response.list(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.mtls_certificates.with_raw_response.list(
                "",
            )
