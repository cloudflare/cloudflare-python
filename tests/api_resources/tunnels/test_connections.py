...
class TestConnections:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        connection = client.tunnels.connections.list(
    ...
    def test_raw_response_list(self, client: Cloudflare) -> None:
        response = client.tunnels.connections.with_raw_response.list(
            "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
            account_id="699d98642c564d2e855e9661899b7252",
        )
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.tunnels.connections.with_streaming_response.list(
            "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
            account_id="699d98642c564d2e855e9661899b7252",
        ) as response:
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.tunnels.connections.with_raw_response.list(
                "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
                account_id="",
            )
...
class TestAsyncConnections:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        connection = await async_client.tunnels.connections.list(
            "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
            account_id="699d98642c564d2e855e9661899b7252",
        )
        assert_matches_type(Optional[ConnectionListResponse], connection, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.tunnels.connections.with_raw_response.list(
            "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
            account_id="699d98642c564d2e855e9661899b7252",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.tunnels.connections.with_streaming_response.list(
            "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
            account_id="699d98642c564d2e855e9661899b7252",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.tunnels.connections.with_raw_response.list(
                "f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
                account_id="",
            )
