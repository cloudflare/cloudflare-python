...
from cloudflare.types.email_routing.rules import CatchAllUpdateResponse, CatchAllGetResponse
...
from cloudflare.types.email_routing.rules import catch_all_update_params
