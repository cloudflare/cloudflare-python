...
from cloudflare.types.email_routing import address_create_params
from cloudflare.types.email_routing import address_list_params
...
class TestAddresses:
    ...
    def test_path_params_delete(self, client: Cloudflare) -> None:
        ...
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `destination_address_identifier` but received ''"):
          client.email_routing.addresses.with_raw_response.delete(
