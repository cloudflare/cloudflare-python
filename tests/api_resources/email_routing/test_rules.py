...
from cloudflare.types.email_routing import rule_create_params
from cloudflare.types.email_routing import rule_update_params
from cloudflare.types.email_routing import rule_list_params
...
class TestRules:
    ...
    def test_method_create(self, client: Cloudflare) -> None:
        rule = client.email_routing.rules.create(
            ...
            actions=[{
                "type": "drop",
                "value": ["destinationaddress@example.net", "destinationaddress@example.net", "destinationaddress@example.net"],
            }, {
                "type": "drop",
                "value": ["destinationaddress@example.net", "destinationaddress@example.net", "destinationaddress@example.net"],
            }, {
