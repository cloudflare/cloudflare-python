...
class TestDevelopmentMode:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        development_mode = client.settings.development_mode.edit(
    ...
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.development_mode.with_raw_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.development_mode.with_streaming_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.development_mode.with_raw_response.edit(
                zone_id="",
                value="on",
            )
...
class TestAsyncDevelopmentMode:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        development_mode = await async_client.settings.development_mode.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(Optional[DevelopmentModeEditResponse], development_mode, path=["response"])
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.development_mode.with_raw_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.development_mode.with_streaming_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.development_mode.with_raw_response.edit(
                zone_id="",
                value="on",
            )
