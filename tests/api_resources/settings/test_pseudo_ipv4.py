...
from cloudflare.types.settings import PseudoIPV4GetResponse, PseudoIPV4EditResponse
...
class TestPseudoIPV4:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        pseudo_ipv4 = client.settings.pseudo_ipv4.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
        assert_matches_type(Optional[PseudoIPV4EditResponse], pseudo_ipv4, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.pseudo_ipv4.with_raw_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.pseudo_ipv4.with_streaming_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        ) as response:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.pseudo_ipv4.with_raw_response.edit(
                zone_id="",
                value="off",
            )
...
class TestAsyncPseudoIPV4:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        pseudo_ipv4 = await async_client.settings.pseudo_ipv4.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
        assert_matches_type(Optional[PseudoIPV4EditResponse], pseudo_ipv4, path=["response"])
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.pseudo_ipv4.with_raw_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.pseudo_ipv4.with_streaming_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.pseudo_ipv4.with_raw_response.edit(
                zone_id="",
                value="off",
            )
