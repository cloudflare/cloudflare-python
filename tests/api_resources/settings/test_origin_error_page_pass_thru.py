...
from cloudflare.types.settings import origin_error_page_pass_thru_update_params
...
class TestOriginErrorPagePassThru:
    ...
    def test_method_update(self, client: Cloudflare) -> None:
        origin_error_page_pass_thru = client.settings.origin_error_page_pass_thru.update(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(
            Optional[OriginErrorPagePassThruUpdateResponse], origin_error_page_pass_thru, path=["response"]
        )

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_update(self, client: Cloudflare) -> None:
        response = client.settings.origin_error_page_pass_thru.with_raw_response.update(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    def test_streaming_response_update(self, client: Cloudflare) -> None:
        with client.settings.origin_error_page_pass_thru.with_streaming_response.update(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
    ...
    def test_path_params_update(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.origin_error_page_pass_thru.with_raw_response.update(
                "",
                value="on",
            )
...
class TestAsyncOriginErrorPagePassThru:
    ...
    async def test_method_update(self, async_client: AsyncCloudflare) -> None:
        origin_error_page_pass_thru = await async_client.settings.origin_error_page_pass_thru.update(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(
    ...
    async def test_raw_response_update(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.origin_error_page_pass_thru.with_raw_response.update(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.origin_error_page_pass_thru.with_streaming_response.update(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.origin_error_page_pass_thru.with_raw_response.update(
                "",
                value="on",
            )
