...
class TestOpportunisticOnion:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        opportunistic_onion = client.settings.opportunistic_onion.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(Optional[OpportunisticOnionEditResponse], opportunistic_onion, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.opportunistic_onion.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.opportunistic_onion.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.opportunistic_onion.with_raw_response.edit(
                "",
                value="on",
            )
...
class TestAsyncOpportunisticOnion:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        opportunistic_onion = await async_client.settings.opportunistic_onion.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(Optional[OpportunisticOnionEditResponse], opportunistic_onion, path=["response"])
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.opportunistic_onion.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.opportunistic_onion.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.opportunistic_onion.with_raw_response.edit(
                "",
                value="on",
            )
