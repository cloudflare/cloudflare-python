...
class TestAutomaticHTTPSRewrites:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        automatic_https_rewrite = client.settings.automatic_https_rewrites.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(Optional[AutomaticHTTPSRewriteEditResponse], automatic_https_rewrite, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.automatic_https_rewrites.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.automatic_https_rewrites.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.automatic_https_rewrites.with_raw_response.edit(
                "",
                value="on",
            )
...
class TestAsyncAutomaticHTTPSRewrites:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        automatic_https_rewrite = await async_client.settings.automatic_https_rewrites.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
        assert_matches_type(Optional[AutomaticHTTPSRewriteEditResponse], automatic_https_rewrite, path=["response"])
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.automatic_https_rewrites.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        )
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.automatic_https_rewrites.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="on",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.automatic_https_rewrites.with_raw_response.edit(
                "",
                value="on",
            )
