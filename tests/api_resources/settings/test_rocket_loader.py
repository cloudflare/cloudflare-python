...
from cloudflare.types.settings import RocketLoaderGetResponse, RocketLoaderEditResponse
...
class TestRocketLoader:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        rocket_loader = client.settings.rocket_loader.edit(
    ...
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.rocket_loader.with_raw_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value={
                "id": "rocket_loader",
                "value": "on",
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.rocket_loader.with_streaming_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value={
                "id": "rocket_loader",
                "value": "on",
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.rocket_loader.with_raw_response.edit(
                zone_id="",
                value={
                    "id": "rocket_loader",
                    "value": "on",
...
class TestAsyncRocketLoader:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        rocket_loader = await async_client.settings.rocket_loader.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value={
                "id": "rocket_loader",
                "value": "on",
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.rocket_loader.with_raw_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value={
                "id": "rocket_loader",
                "value": "on",
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.rocket_loader.with_streaming_response.edit(
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            value={
                "id": "rocket_loader",
                "value": "on",
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.rocket_loader.with_raw_response.edit(
                zone_id="",
                value={
                    "id": "rocket_loader",
                    "value": "on",
