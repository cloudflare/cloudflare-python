...
from cloudflare.types.settings import MinTLSVersionGetResponse, MinTLSVersionEditResponse
...
class TestMinTLSVersion:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        min_tls_version = client.settings.min_tls_version.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="1.0",
        )
        assert_matches_type(Optional[MinTLSVersionEditResponse], min_tls_version, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.min_tls_version.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="1.0",
        )
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.min_tls_version.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="1.0",
        ) as response:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.min_tls_version.with_raw_response.edit(
                "",
                value="1.0",
            )
...
class TestAsyncMinTLSVersion:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        min_tls_version = await async_client.settings.min_tls_version.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="1.0",
        )
        assert_matches_type(Optional[MinTLSVersionEditResponse], min_tls_version, path=["response"])
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.min_tls_version.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="1.0",
        )
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.min_tls_version.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="1.0",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.min_tls_version.with_raw_response.edit(
                "",
                value="1.0",
            )
