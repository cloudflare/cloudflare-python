...
from cloudflare.types.settings import CipherGetResponse, CipherUpdateResponse
...
class TestCiphers:
    ...
    def test_method_get(self, client: Cloudflare) -> None:
        cipher = client.settings.ciphers.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_raw_response_get(self, client: Cloudflare) -> None:
        response = client.settings.ciphers.with_raw_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_streaming_response_get(self, client: Cloudflare) -> None:
        with client.settings.ciphers.with_streaming_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.ciphers.with_raw_response.get(
                "",
            )
...
class TestAsyncCiphers:
    ...
    async def test_method_get(self, async_client: AsyncCloudflare) -> None:
        cipher = await async_client.settings.ciphers.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(Optional[CipherGetResponse], cipher, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.ciphers.with_raw_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.ciphers.with_streaming_response.get(
            "023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.ciphers.with_raw_response.get(
                "",
            )
