...
from cloudflare.types.settings import WebpGetResponse, WebpEditResponse
...
class TestWebp:
    ...
    def test_method_edit(self, client: Cloudflare) -> None:
        webp = client.settings.webp.edit(
    ...
    def test_raw_response_edit(self, client: Cloudflare) -> None:
        response = client.settings.webp.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
    ...
    def test_streaming_response_edit(self, client: Cloudflare) -> None:
        with client.settings.webp.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        ) as response:
    ...
    def test_path_params_edit(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.settings.webp.with_raw_response.edit(
                "",
                value="off",
            )
...
class TestAsyncWebp:
    ...
    async def test_method_edit(self, async_client: AsyncCloudflare) -> None:
        webp = await async_client.settings.webp.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
        assert_matches_type(Optional[WebpEditResponse], webp, path=["response"])
    ...
    async def test_raw_response_edit(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.settings.webp.with_raw_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        )
    ...
    async def test_streaming_response_edit(self, async_client: AsyncCloudflare) -> None:
        async with async_client.settings.webp.with_streaming_response.edit(
            "023e105f4ecef8ad9ca31a8372d0c353",
            value="off",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_edit(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.settings.webp.with_raw_response.edit(
                "",
                value="off",
            )
