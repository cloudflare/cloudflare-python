...
class TestMarkdown:
    ...
    def test_raw_response_create(self, client: Cloudflare) -> None:
        response = client.browser_rendering.markdown.with_raw_response.create(
            account_id="account_id",
        )
    ...
    def test_streaming_response_create(self, client: Cloudflare) -> None:
        with client.browser_rendering.markdown.with_streaming_response.create(
            account_id="account_id",
        ) as response:
    ...
    def test_path_params_create(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.browser_rendering.markdown.with_raw_response.create(
                account_id="",
            )
...
class TestAsyncMarkdown:
    ...
    async def test_raw_response_create(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.browser_rendering.markdown.with_raw_response.create(
            account_id="account_id",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncCloudflare) -> None:
        async with async_client.browser_rendering.markdown.with_streaming_response.create(
            account_id="account_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.browser_rendering.markdown.with_raw_response.create(
                account_id="",
            )
