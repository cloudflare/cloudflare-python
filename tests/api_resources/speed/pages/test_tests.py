...
from cloudflare.types.speed.pages import test_create_params
from cloudflare.types.speed.pages import test_list_params
from cloudflare.types.speed.pages import test_delete_params
