...
from cloudflare.types.secondary_dns import OutgoingCreateResponse, OutgoingUpdateResponse, OutgoingDeleteResponse, DisableTransfer, EnableTransfer, OutgoingForceNotifyResponse, OutgoingGetResponse
