...
from cloudflare.types.secondary_dns import outgoing_secondary_dns_primary_zone_create_primary_zone_configuration_params
from cloudflare.types.secondary_dns import outgoing_secondary_dns_primary_zone_update_primary_zone_configuration_params
