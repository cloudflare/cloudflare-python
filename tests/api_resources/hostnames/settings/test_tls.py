...
class TestTLS:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        tls = client.hostnames.settings.tls.list(
            setting_id="ciphers",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(SyncSinglePage[TLSListResponse], tls, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Cloudflare) -> None:
        response = client.hostnames.settings.tls.with_raw_response.list(
            setting_id="ciphers",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_streaming_response_list(self, client: Cloudflare) -> None:
        with client.hostnames.settings.tls.with_streaming_response.list(
            setting_id="ciphers",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.hostnames.settings.tls.with_raw_response.list(
                setting_id="ciphers",
                zone_id="",
            )
...
class TestAsyncTLS:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        tls = await async_client.hostnames.settings.tls.list(
            setting_id="ciphers",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(AsyncSinglePage[TLSListResponse], tls, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.hostnames.settings.tls.with_raw_response.list(
            setting_id="ciphers",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCloudflare) -> None:
        async with async_client.hostnames.settings.tls.with_streaming_response.list(
            setting_id="ciphers",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.hostnames.settings.tls.with_raw_response.list(
                setting_id="ciphers",
                zone_id="",
            )
