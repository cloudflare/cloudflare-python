...
from cloudflare.types.r2.domains import ManagedGetResponse, ManagedUpdateResponse
...
class TestManaged:
    ...
    def test_method_get(self, client: Cloudflare) -> None:
        managed = client.r2.domains.managed.get(
            bucket_name="example-bucket",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(ManagedGetResponse, managed, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Cloudflare) -> None:
        response = client.r2.domains.managed.with_raw_response.get(
            bucket_name="example-bucket",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    def test_streaming_response_get(self, client: Cloudflare) -> None:
        with client.r2.domains.managed.with_streaming_response.get(
            bucket_name="example-bucket",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.r2.domains.managed.with_raw_response.get(
                bucket_name="example-bucket",
                account_id="",
            )
...
class TestAsyncManaged:
    ...
    async def test_method_get(self, async_client: AsyncCloudflare) -> None:
        managed = await async_client.r2.domains.managed.get(
            bucket_name="example-bucket",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
        assert_matches_type(ManagedGetResponse, managed, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.r2.domains.managed.with_raw_response.get(
            bucket_name="example-bucket",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCloudflare) -> None:
        async with async_client.r2.domains.managed.with_streaming_response.get(
            bucket_name="example-bucket",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.r2.domains.managed.with_raw_response.get(
                bucket_name="example-bucket",
                account_id="",
            )
