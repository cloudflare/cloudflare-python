...
from cloudflare.types.r2 import BucketCreateResponse, BucketListResponse, BucketGetResponse
...
from cloudflare.types.r2 import bucket_create_params
from cloudflare.types.r2 import bucket_list_params
