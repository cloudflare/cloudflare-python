...
from cloudflare.types.vectorize.indexes import metadata_index_create_params
from cloudflare.types.vectorize.indexes import metadata_index_delete_params
