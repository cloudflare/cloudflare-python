...
class TestPayloads:
    ...
    def test_method_update(self, client: Cloudflare) -> None:
        payload = client.content_scanning.payloads.update(
            expression_id="a350a054caa840c9becd89c3b4f0195b",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            payload='lookup_json_string(http.request.body.raw, "file")',
        )
        assert_matches_type(SyncSinglePage[PayloadUpdateResponse], payload, path=["response"])

    @parametrize
    def test_raw_response_update(self, client: Cloudflare) -> None:
        response = client.content_scanning.payloads.with_raw_response.update(
            expression_id="a350a054caa840c9becd89c3b4f0195b",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            payload='lookup_json_string(http.request.body.raw, "file")',
        )
    ...
    def test_streaming_response_update(self, client: Cloudflare) -> None:
        with client.content_scanning.payloads.with_streaming_response.update(
            expression_id="a350a054caa840c9becd89c3b4f0195b",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            payload='lookup_json_string(http.request.body.raw, "file")',
        ) as response:
    ...
    def test_path_params_update(self, client: Cloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.content_scanning.payloads.with_raw_response.update(
                expression_id="a350a054caa840c9becd89c3b4f0195b",
                zone_id="",
                payload='lookup_json_string(http.request.body.raw, "file")',
            )
...
class TestAsyncPayloads:
    ...
    async def test_method_update(self, async_client: AsyncCloudflare) -> None:
        payload = await async_client.content_scanning.payloads.update(
            expression_id="a350a054caa840c9becd89c3b4f0195b",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            payload='lookup_json_string(http.request.body.raw, "file")',
        )
        assert_matches_type(AsyncSinglePage[PayloadUpdateResponse], payload, path=["response"])

    @parametrize
    async def test_raw_response_update(self, async_client: AsyncCloudflare) -> None:
        response = await async_client.content_scanning.payloads.with_raw_response.update(
            expression_id="a350a054caa840c9becd89c3b4f0195b",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            payload='lookup_json_string(http.request.body.raw, "file")',
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCloudflare) -> None:
        async with async_client.content_scanning.payloads.with_streaming_response.update(
            expression_id="a350a054caa840c9becd89c3b4f0195b",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            payload='lookup_json_string(http.request.body.raw, "file")',
        ) as response:
    ...
    async def test_path_params_update(self, async_client: AsyncCloudflare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.content_scanning.payloads.with_raw_response.update(
                expression_id="a350a054caa840c9becd89c3b4f0195b",
                zone_id="",
                payload='lookup_json_string(http.request.body.raw, "file")',
            )
