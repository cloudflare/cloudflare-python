...
class Actor(BaseModel):
    ...
    context: Optional[Literal["api", "api_key", "api_token", "dash", "oauth", "origin_ca_key"]] = None
    ...
    type: Optional[Literal["account", "cloudflare_admin", "delegated_service", "system", "user"]] = None
    """The type of actor."""
