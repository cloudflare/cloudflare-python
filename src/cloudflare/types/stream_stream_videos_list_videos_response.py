...
__all__ = [
    ...
    "StreamStreamVideosListVideosResponseItem",
    "StreamStreamVideosListVideosResponseItemInput",
    "StreamStreamVideosListVideosResponseItemPlayback",
    "StreamStreamVideosListVideosResponseItemStatus",
    "StreamStreamVideosListVideosResponseItemWatermark",
]


class StreamStreamVideosListVideosResponseItemInput(BaseModel):
...
class StreamStreamVideosListVideosResponseItemPlayback(BaseModel):
...
class StreamStreamVideosListVideosResponseItemStatus(BaseModel):
...
class StreamStreamVideosListVideosResponseItemWatermark(BaseModel):
...
class StreamStreamVideosListVideosResponseItem(BaseModel):
    ...
    input: Optional[StreamStreamVideosListVideosResponseItemInput] = None
    ...
    playback: Optional[StreamStreamVideosListVideosResponseItemPlayback] = None
    ...
    status: Optional[StreamStreamVideosListVideosResponseItemStatus] = None
    ...
    watermark: Optional[StreamStreamVideosListVideosResponseItemWatermark] = None


StreamStreamVideosListVideosResponse = List[StreamStreamVideosListVideosResponseItem]
