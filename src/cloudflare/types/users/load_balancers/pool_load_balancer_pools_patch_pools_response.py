...
__all__ = [
    ...
    "PoolLoadBalancerPoolsPatchPoolsResponseItem",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemLoadShedding",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilter",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterOrigin",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterPool",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemOriginSteering",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemOrigin",
    "PoolLoadBalancerPoolsPatchPoolsResponseItemOriginHeader",
]


class PoolLoadBalancerPoolsPatchPoolsResponseItemLoadShedding(BaseModel):
...
class PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterOrigin(BaseModel):
...
class PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterPool(BaseModel):
    disable: Optional[bool] = None
    """If set true, disable notifications for this type of resource (pool or origin)."""
...
class PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilter(BaseModel):
    origin: Optional[PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterOrigin] = None
    """Filter options for a particular resource type (pool or origin).

    Use null to reset.
    """

    pool: Optional[PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterPool] = None
    """Filter options for a particular resource type (pool or origin).
...
class PoolLoadBalancerPoolsPatchPoolsResponseItemOriginSteering(BaseModel):
...
class PoolLoadBalancerPoolsPatchPoolsResponseItemOriginHeader(BaseModel):
...
class PoolLoadBalancerPoolsPatchPoolsResponseItemOrigin(BaseModel):
    ...
    header: Optional[PoolLoadBalancerPoolsPatchPoolsResponseItemOriginHeader] = None
...
class PoolLoadBalancerPoolsPatchPoolsResponseItem(BaseModel):
    ...
    load_shedding: Optional[PoolLoadBalancerPoolsPatchPoolsResponseItemLoadShedding] = None
    ...
    notification_filter: Optional[PoolLoadBalancerPoolsPatchPoolsResponseItemNotificationFilter] = None
    """Filter pool and origin health notifications by resource type or health status.

    Use null to reset.
    """

    origin_steering: Optional[PoolLoadBalancerPoolsPatchPoolsResponseItemOriginSteering] = None
    ...
    origins: Optional[List[PoolLoadBalancerPoolsPatchPoolsResponseItemOrigin]] = None
...
PoolLoadBalancerPoolsPatchPoolsResponse = List[PoolLoadBalancerPoolsPatchPoolsResponseItem]
