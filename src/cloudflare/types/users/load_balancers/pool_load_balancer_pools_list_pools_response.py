...
__all__ = [
    ...
    "PoolLoadBalancerPoolsListPoolsResponseItem",
    "PoolLoadBalancerPoolsListPoolsResponseItemLoadShedding",
    "PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilter",
    "PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilterOrigin",
    "PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilterPool",
    "PoolLoadBalancerPoolsListPoolsResponseItemOriginSteering",
    "PoolLoadBalancerPoolsListPoolsResponseItemOrigin",
    "PoolLoadBalancerPoolsListPoolsResponseItemOriginHeader",
]


class PoolLoadBalancerPoolsListPoolsResponseItemLoadShedding(BaseModel):
...
class PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilterOrigin(BaseModel):
...
class PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilterPool(BaseModel):
    disable: Optional[bool] = None
    """If set true, disable notifications for this type of resource (pool or origin)."""
...
class PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilter(BaseModel):
    origin: Optional[PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilterOrigin] = None
    """Filter options for a particular resource type (pool or origin).

    Use null to reset.
    """

    pool: Optional[PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilterPool] = None
    """Filter options for a particular resource type (pool or origin).
...
class PoolLoadBalancerPoolsListPoolsResponseItemOriginSteering(BaseModel):
...
class PoolLoadBalancerPoolsListPoolsResponseItemOriginHeader(BaseModel):
...
class PoolLoadBalancerPoolsListPoolsResponseItemOrigin(BaseModel):
    ...
    header: Optional[PoolLoadBalancerPoolsListPoolsResponseItemOriginHeader] = None
...
class PoolLoadBalancerPoolsListPoolsResponseItem(BaseModel):
    ...
    load_shedding: Optional[PoolLoadBalancerPoolsListPoolsResponseItemLoadShedding] = None
    ...
    notification_filter: Optional[PoolLoadBalancerPoolsListPoolsResponseItemNotificationFilter] = None
    """Filter pool and origin health notifications by resource type or health status.

    Use null to reset.
    """

    origin_steering: Optional[PoolLoadBalancerPoolsListPoolsResponseItemOriginSteering] = None
    ...
    origins: Optional[List[PoolLoadBalancerPoolsListPoolsResponseItemOrigin]] = None
...
PoolLoadBalancerPoolsListPoolsResponse = List[PoolLoadBalancerPoolsListPoolsResponseItem]
