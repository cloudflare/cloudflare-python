...
__all__ = ["RuleIPAccessRulesForAUserListIPAccessRulesParams", "EgsPagination", "EgsPaginationJson", "Filters"]


class RuleIPAccessRulesForAUserListIPAccessRulesParams(TypedDict, total=False):
