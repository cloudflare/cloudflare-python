...
__all__ = ["ServiceTokenListResponse", "ServiceTokenListResponseItem"]


class ServiceTokenListResponseItem(BaseModel):
...
ServiceTokenListResponse = List[ServiceTokenListResponseItem]
