...
class SelfHostedApplication(BaseModel):
    ...
    allowed_idps: Optional[List[AllowedIDPsItem]] = None
    ...
    custom_pages: Optional[List[CustomPagesItem]] = None
    ...
    self_hosted_domains: Optional[List[SelfHostedDomainsItem]] = None
