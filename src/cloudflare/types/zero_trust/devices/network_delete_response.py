...
__all__ = ["NetworkDeleteResponse", "NetworkDeleteResponseItem", "NetworkDeleteResponseItemConfig"]


class NetworkDeleteResponseItemConfig(BaseModel):
    tls_sockaddr: str
    """
...
class NetworkDeleteResponseItem(BaseModel):
    config: Optional[NetworkDeleteResponseItemConfig] = None
    """
...
NetworkDeleteResponse = List[NetworkDeleteResponseItem]
