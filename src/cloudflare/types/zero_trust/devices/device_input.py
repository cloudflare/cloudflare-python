...
__all__ = ["DeviceInput", "TeamsDevicesCarbonblackInputRequest", "TeamsDevicesApplicationInputRequest", "TeamsDevicesClientCertificateV2InputRequest", "TeamsDevicesClientCertificateV2InputRequestLocations"]
...
DeviceInput: TypeAlias = Union[FileInput, UniqueClientIDInput, DomainJoinedInput, OSVersionInput, FirewallInput, SentineloneInput, TeamsDevicesCarbonblackInputRequest, DiskEncryptionInput, TeamsDevicesApplicationInputRequest, ClientCertificateInput, TeamsDevicesClientCertificateV2InputRequest, WorkspaceOneInput, CrowdstrikeInput, IntuneInput, KolideInput, TaniumInput, SentineloneS2sInput]