...
__all__ = ["NetworkListResponse", "NetworkListResponseItem", "NetworkListResponseItemConfig"]


class NetworkListResponseItemConfig(BaseModel):
    tls_sockaddr: str
    """
...
class NetworkListResponseItem(BaseModel):
    config: Optional[NetworkListResponseItemConfig] = None
    """
...
NetworkListResponse = List[NetworkListResponseItem]
