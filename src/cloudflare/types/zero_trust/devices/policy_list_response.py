...
class PolicyListResponseItemExclude(BaseModel):
    address: str
...
class PolicyListResponseItemFallbackDomain(BaseModel):
    suffix: str
...
class PolicyListResponseItemInclude(BaseModel):
    address: str
...
class PolicyListResponseItemServiceModeV2(BaseModel):
...
class PolicyListResponseItem(BaseModel):
    ...
    fallback_domains: Optional[List[PolicyListResponseItemFallbackDomain]] = None
    ...
    service_mode_v2: Optional[PolicyListResponseItemServiceModeV2] = None
