...
class Test(BaseModel):
    ...
    traceroute_results_by_colo: Optional[List[TestTracerouteResultsByColo]] = FieldInfo(alias = "tracerouteResultsByColo", default = None)
