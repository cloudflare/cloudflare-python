...
__all__ = ["LocationListResponse", "LocationListResponseItem", "LocationListResponseItemNetwork"]


class LocationListResponseItemNetwork(BaseModel):
    network: str
    """The IPv4 address or IPv4 CIDR. IPv4 CIDRs are limited to a maximum of /24."""


class LocationListResponseItem(BaseModel):
    ...
    networks: Optional[List[LocationListResponseItemNetwork]] = None
    """A list of network ranges that requests from this location would originate from."""

    updated_at: Optional[datetime] = None


LocationListResponse = List[LocationListResponseItem]
