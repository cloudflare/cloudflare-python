...
__all__ = [
    ...
    "HealthcheckHealthChecksListHealthChecksResponseItem",
    "HealthcheckHealthChecksListHealthChecksResponseItemHTTPConfig",
    "HealthcheckHealthChecksListHealthChecksResponseItemTcpConfig",
]


class HealthcheckHealthChecksListHealthChecksResponseItemHTTPConfig(BaseModel):
...
class HealthcheckHealthChecksListHealthChecksResponseItemTcpConfig(BaseModel):
...
class HealthcheckHealthChecksListHealthChecksResponseItem(BaseModel):
    ...
    http_config: Optional[HealthcheckHealthChecksListHealthChecksResponseItemHTTPConfig] = None
    ...
    tcp_config: Optional[HealthcheckHealthChecksListHealthChecksResponseItemTcpConfig] = None
...
HealthcheckHealthChecksListHealthChecksResponse = List[HealthcheckHealthChecksListHealthChecksResponseItem]
