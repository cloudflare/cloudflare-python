...
__all__ = [
    "PrefixListResponse",
    "PrefixListResponseItem",
    "PrefixListResponseItemBGPSignalOpts",
    "PrefixListResponseItemOnDemand",
]


class PrefixListResponseItemBGPSignalOpts(BaseModel):
...
class PrefixListResponseItemOnDemand(BaseModel):
...
class PrefixListResponseItem(BaseModel):
    ...
    bgp_signal_opts: Optional[PrefixListResponseItemBGPSignalOpts] = None
    ...
    on_demand: Optional[PrefixListResponseItemOnDemand] = None


PrefixListResponse = List[PrefixListResponseItem]
