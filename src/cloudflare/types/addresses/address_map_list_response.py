...
__all__ = ["AddressMapListResponse", "AddressMapListResponseItem"]


class AddressMapListResponseItem(BaseModel):
...
AddressMapListResponse = List[AddressMapListResponseItem]
