...
__all__ = [
    ...
    "PrefixIPAddressManagementPrefixesListPrefixesResponseItem",
]


class PrefixIPAddressManagementPrefixesListPrefixesResponseItem(BaseModel):
...
PrefixIPAddressManagementPrefixesListPrefixesResponse = List[PrefixIPAddressManagementPrefixesListPrefixesResponseItem]
