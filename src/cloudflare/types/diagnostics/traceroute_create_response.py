...
__all__ = [
    ...
    "TracerouteCreateResponseItem",
    "TracerouteCreateResponseItemColo",
    "TracerouteCreateResponseItemColoColo",
    "TracerouteCreateResponseItemColoHop",
    "TracerouteCreateResponseItemColoHopNode",
]


class TracerouteCreateResponseItemColoColo(BaseModel):
...
class TracerouteCreateResponseItemColoHopNode(BaseModel):
...
class TracerouteCreateResponseItemColoHop(BaseModel):
    nodes: Optional[List[TracerouteCreateResponseItemColoHopNode]] = None
...
class TracerouteCreateResponseItemColo(BaseModel):
    colo: Optional[TracerouteCreateResponseItemColoColo] = None
    ...
    hops: Optional[List[TracerouteCreateResponseItemColoHop]] = None
...
class TracerouteCreateResponseItem(BaseModel):
    colos: Optional[List[TracerouteCreateResponseItemColo]] = None

    target: Optional[str] = None
    """The target hostname, IPv6, or IPv6 address."""


TracerouteCreateResponse = List[TracerouteCreateResponseItem]
