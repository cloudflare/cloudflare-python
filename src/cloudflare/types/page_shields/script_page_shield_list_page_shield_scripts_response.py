...
__all__ = ["ScriptPageShieldListPageShieldScriptsResponse", "ScriptPageShieldListPageShieldScriptsResponseItem"]


class ScriptPageShieldListPageShieldScriptsResponseItem(BaseModel):
...
ScriptPageShieldListPageShieldScriptsResponse = List[ScriptPageShieldListPageShieldScriptsResponseItem]
