...
__all__ = [
    ...
    "ConnectionPageShieldListPageShieldConnectionsResponseItem",
]


class ConnectionPageShieldListPageShieldConnectionsResponseItem(BaseModel):
...
ConnectionPageShieldListPageShieldConnectionsResponse = List[ConnectionPageShieldListPageShieldConnectionsResponseItem]
