...
__all__ = ["PreviewHealthChecksCreatePreviewHealthCheckParams", "HTTPConfig", "TcpConfig"]


class PreviewHealthChecksCreatePreviewHealthCheckParams(TypedDict, total=False):
