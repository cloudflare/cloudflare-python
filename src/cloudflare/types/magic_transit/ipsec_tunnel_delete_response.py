...
__all__ = [
    ...
    "DeletedIPSECTunnel",
    "DeletedIPSECTunnelBGP",
    "DeletedIPSECTunnelBGPStatus",
    "DeletedIPSECTunnelCustomRemoteIdentities",
...
class DeletedIPSECTunnelBGP(BaseModel):
    customer_asn: int
...
class DeletedIPSECTunnelBGPStatus(BaseModel):
...
class DeletedIPSECTunnelCustomRemoteIdentities(BaseModel):
...
class DeletedIPSECTunnel(BaseModel):
    ...
    bgp_status: Optional[DeletedIPSECTunnelBGPStatus] = None

    created_on: Optional[datetime] = None
    """The date and time the tunnel was created."""

    custom_remote_identities: Optional[DeletedIPSECTunnelCustomRemoteIdentities] = None
