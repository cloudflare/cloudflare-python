...
__all__ = [
    ...
    "DeletedGRETunnel",
    "DeletedGRETunnelBGP",
    "DeletedGRETunnelBGPStatus",
    "DeletedGRETunnelHealthCheck",
    "DeletedGRETunnelHealthCheckTarget",
    "DeletedGRETunnelHealthCheckTargetMagicHealthCheckTarget",
]


class DeletedGRETunnelBGP(BaseModel):
    customer_asn: int
...
class DeletedGRETunnelBGPStatus(BaseModel):
...
class DeletedGRETunnelHealthCheckTargetMagicHealthCheckTarget(BaseModel):
...
DeletedGRETunnelHealthCheckTarget: TypeAlias = Union[DeletedGRETunnelHealthCheckTargetMagicHealthCheckTarget, str]


class DeletedGRETunnelHealthCheck(BaseModel):
    ...
    target: Optional[DeletedGRETunnelHealthCheckTarget] = None
    """The destination address in a request type health check.
...
class DeletedGRETunnel(BaseModel):
    ...
    bgp_status: Optional[DeletedGRETunnelBGPStatus] = None
...
class GRETunnelDeleteResponse(BaseModel):
    ...
    deleted_gre_tunnel: Optional[DeletedGRETunnel] = None
