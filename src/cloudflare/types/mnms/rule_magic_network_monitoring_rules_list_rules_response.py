...
__all__ = ["RuleMagicNetworkMonitoringRulesListRulesResponse", "RuleMagicNetworkMonitoringRulesListRulesResponseItem"]


class RuleMagicNetworkMonitoringRulesListRulesResponseItem(BaseModel):
...
RuleMagicNetworkMonitoringRulesListRulesResponse = List[Optional[RuleMagicNetworkMonitoringRulesListRulesResponseItem]]
