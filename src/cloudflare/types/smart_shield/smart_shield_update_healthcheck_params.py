...
from ..shared_params.response_info import ResponseInfo

__all__ = ["SmartShieldUpdateHealthcheckParams", "Result", "ResultHTTPConfig", "ResultTCPConfig"]


class SmartShieldUpdateHealthcheckParams(TypedDict, total=False):
    zone_id: Required[str]
    """Identifier."""

    errors: Required[Iterable[ResponseInfo]]

    messages: Required[Iterable[ResponseInfo]]
...
class ResultHTTPConfig(TypedDict, total=False):
    allow_insecure: bool
...
class ResultTCPConfig(TypedDict, total=False):
...
class Result(TypedDict, total=False):
    ...
    http_config: Optional[ResultHTTPConfig]
    ...
    tcp_config: Optional[ResultTCPConfig]
