...
__all__ = ["SubscriptionAccountSubscriptionsCreateSubscriptionParams", "App", "ComponentValue", "RatePlan", "Zone"]


class SubscriptionAccountSubscriptionsCreateSubscriptionParams(TypedDict, total=False):
    app: App
