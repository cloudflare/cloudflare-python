...
__all__ = ["IntegrationDevicePostureIntegrationsCreateDevicePostureIntegrationResponse", "Config"]
...
class IntegrationDevicePostureIntegrationsCreateDevicePostureIntegrationResponse(BaseModel):
