...
__all__ = ["NetworkDeviceManagedNetworksCreateDeviceManagedNetworkResponse", "Config"]
...
class NetworkDeviceManagedNetworksCreateDeviceManagedNetworkResponse(BaseModel):
