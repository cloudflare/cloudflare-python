...
__all__ = [
    ...
    "PolicyDevicesListDeviceSettingsPoliciesResponseItem",
    "PolicyDevicesListDeviceSettingsPoliciesResponseItemExclude",
    "PolicyDevicesListDeviceSettingsPoliciesResponseItemFallbackDomain",
    "PolicyDevicesListDeviceSettingsPoliciesResponseItemInclude",
    "PolicyDevicesListDeviceSettingsPoliciesResponseItemServiceModeV2",
]


class PolicyDevicesListDeviceSettingsPoliciesResponseItemExclude(BaseModel):
    address: str
...
class PolicyDevicesListDeviceSettingsPoliciesResponseItemFallbackDomain(BaseModel):
    suffix: str
...
class PolicyDevicesListDeviceSettingsPoliciesResponseItemInclude(BaseModel):
    address: str
...
class PolicyDevicesListDeviceSettingsPoliciesResponseItemServiceModeV2(BaseModel):
...
class PolicyDevicesListDeviceSettingsPoliciesResponseItem(BaseModel):
    ...
    exclude: Optional[List[PolicyDevicesListDeviceSettingsPoliciesResponseItemExclude]] = None

    exclude_office_ips: Optional[bool] = None
    """Whether to add Microsoft IPs to Split Tunnel exclusions."""

    fallback_domains: Optional[List[PolicyDevicesListDeviceSettingsPoliciesResponseItemFallbackDomain]] = None

    gateway_unique_id: Optional[str] = None

    include: Optional[List[PolicyDevicesListDeviceSettingsPoliciesResponseItemInclude]] = None
    ...
    service_mode_v2: Optional[PolicyDevicesListDeviceSettingsPoliciesResponseItemServiceModeV2] = None
...
PolicyDevicesListDeviceSettingsPoliciesResponse = List[PolicyDevicesListDeviceSettingsPoliciesResponseItem]
