...
__all__ = ["ExcludeDevicesSetSplitTunnelExcludeListForADeviceSettingsPolicyParams", "Body"]


class ExcludeDevicesSetSplitTunnelExcludeListForADeviceSettingsPolicyParams(TypedDict, total=False):
