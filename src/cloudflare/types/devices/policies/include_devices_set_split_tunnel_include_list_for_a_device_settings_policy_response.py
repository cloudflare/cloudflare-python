...
__all__ = [
    ...
    "IncludeDevicesSetSplitTunnelIncludeListForADeviceSettingsPolicyResponseItem",
]


class IncludeDevicesSetSplitTunnelIncludeListForADeviceSettingsPolicyResponseItem(BaseModel):
    address: str
...
IncludeDevicesSetSplitTunnelIncludeListForADeviceSettingsPolicyResponse = List[
    IncludeDevicesSetSplitTunnelIncludeListForADeviceSettingsPolicyResponseItem
]
