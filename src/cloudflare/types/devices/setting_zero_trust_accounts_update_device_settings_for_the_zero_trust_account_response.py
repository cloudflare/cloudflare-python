...
__all__ = ["SettingZeroTrustAccountsUpdateDeviceSettingsForTheZeroTrustAccountResponse"]


class SettingZeroTrustAccountsUpdateDeviceSettingsForTheZeroTrustAccountResponse(BaseModel):
