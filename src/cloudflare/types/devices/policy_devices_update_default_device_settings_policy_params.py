...
__all__ = ["PolicyDevicesUpdateDefaultDeviceSettingsPolicyParams", "ServiceModeV2"]


class PolicyDevicesUpdateDefaultDeviceSettingsPolicyParams(TypedDict, total=False):
