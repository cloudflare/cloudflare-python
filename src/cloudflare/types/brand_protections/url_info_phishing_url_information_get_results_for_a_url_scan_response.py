...
class ModelResult(BaseModel):
    ...
    api_model_score: Optional[float] = FieldInfo(alias="model_score", default=None)
...
class URLInfoPhishingURLInformationGetResultsForAURLScanResponse(BaseModel):
    categorizations: Optional[List[Categorization]] = None
    """List of categorizations applied to this submission."""

    api_model_results: Optional[List[ModelResult]] = FieldInfo(alias="model_results", default=None)
