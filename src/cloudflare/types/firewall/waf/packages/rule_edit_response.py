...
__all__ = ["RuleEditResponse", "WAFManagedRulesAnomalyRule", "WAFManagedRulesTraditionalDenyRule", "WAFManagedRulesTraditionalAllowRule"]
...
RuleEditResponse: TypeAlias = Union[WAFManagedRulesAnomalyRule, WAFManagedRulesTraditionalDenyRule, WAFManagedRulesTraditionalAllowRule]