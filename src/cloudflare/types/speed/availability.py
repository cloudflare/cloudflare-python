...
__all__ = ["Availability", "Quota", "QuotaQuotasPerPlan", "QuotaQuotasPerPlanValue", "QuotaScheduleQuotasPerPlan", "QuotaScheduleQuotasPerPlanValue", "RegionsPerPlan"]
...
class Quota(BaseModel):
    ...
    schedule_quotas_per_plan: Optional[QuotaScheduleQuotasPerPlan] = FieldInfo(alias = "scheduleQuotasPerPlan", default = None)
