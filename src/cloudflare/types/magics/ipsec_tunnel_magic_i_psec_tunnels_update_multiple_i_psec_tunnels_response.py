...
__all__ = [
    ...
    "ModifiedIpsecTunnel",
    "ModifiedIpsecTunnelPskMetadata",
    "ModifiedIpsecTunnelTunnelHealthCheck",
]


class ModifiedIpsecTunnelPskMetadata(BaseModel):
    last_generated_on: Optional[datetime] = None
    """The date and time the tunnel was last modified."""


class ModifiedIpsecTunnelTunnelHealthCheck(BaseModel):
...
class ModifiedIpsecTunnel(BaseModel):
    ...
    psk_metadata: Optional[ModifiedIpsecTunnelPskMetadata] = None
    ...
    tunnel_health_check: Optional[ModifiedIpsecTunnelTunnelHealthCheck] = None


class IpsecTunnelMagicIPsecTunnelsUpdateMultipleIPsecTunnelsResponse(BaseModel):
