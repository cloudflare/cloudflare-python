...
__all__ = ["AuditLogAuditLogsGetAccountAuditLogsResponse", "UnionMember0", "UnionMember0Result", "UnionMember0ResultAction", "UnionMember0ResultActor", "UnionMember0ResultOwner", "UnionMember0ResultResource", "_4R3gc1ffAPIResponseCommon", "4R3gc1ffAPIResponseCommonError", "4R3gc1ffAPIResponseCommonMessage"]
...
class 4R3gc1ffAPIResponseCommonError(BaseModel):
    code: int

    message: str

class 4R3gc1ffAPIResponseCommonMessage(BaseModel):
    code: int

    message: str

class _4R3gc1ffAPIResponseCommon(BaseModel):
    errors: List[4R3gc1ffAPIResponseCommonError]

    messages: List[4R3gc1ffAPIResponseCommonMessage]
...
AuditLogAuditLogsGetAccountAuditLogsResponse = Union[UnionMember0, _4R3gc1ffAPIResponseCommon]