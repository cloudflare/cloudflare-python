...
__all__ = ["AuditLogAuditLogsGetAccountAuditLogsResponse", "UnionMember0", "UnionMember0Result", "UnionMember0ResultAction", "UnionMember0ResultActor", "UnionMember0ResultOwner", "UnionMember0ResultResource", "_7B8bPyv1APIResponseCommon", "7B8bPyv1APIResponseCommonError", "7B8bPyv1APIResponseCommonMessage"]
...
class 7B8bPyv1APIResponseCommonError(BaseModel):
    code: int

    message: str

class 7B8bPyv1APIResponseCommonMessage(BaseModel):
    code: int

    message: str

class _7B8bPyv1APIResponseCommon(BaseModel):
    errors: List[7B8bPyv1APIResponseCommonError]

    messages: List[7B8bPyv1APIResponseCommonMessage]
...
AuditLogAuditLogsGetAccountAuditLogsResponse = Union[UnionMember0, _7B8bPyv1APIResponseCommon]