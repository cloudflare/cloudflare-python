...
__all__ = ["HostnameAssociationClientCertificateForAZoneListHostnameAssociationsResponse"]


class HostnameAssociationClientCertificateForAZoneListHostnameAssociationsResponse(BaseModel):
