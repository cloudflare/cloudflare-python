...
__all__ = ["AnalyticsQueryTimeseriesParams", "Filter"]


class AnalyticsQueryTimeseriesParams(TypedDict, total=False):
    ...
    """Time bucket size for grouping results.

    Controls the granularity of the returned time slots.
    """
