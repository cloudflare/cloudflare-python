...
__all__ = [
    ...
    "SettingsBindingWorkersBindingKindMessaging",
    ...
    "SettingsExports",
    "SettingsExportsWorkersWorkerExport",
    "SettingsExportsWorkersWorkerExportCache",
    "SettingsExportsWorkersDurableObjectExport",
    "SettingsExportsWorkersDurableObjectDeletedExport",
    "SettingsExportsWorkersDurableObjectRenamedExport",
    "SettingsExportsWorkersDurableObjectTransferredExport",
    "SettingsExportsWorkersDurableObjectExpectingTransferExport",
    "SettingsLimits",
    "SettingsMigrations",
...
class SettingsBindingWorkersBindingKindMessaging(TypedDict, total=False):
    name: Required[str]
    """A JavaScript variable name for the binding."""
...
class SettingsBindingWorkersBindingKindR2Bucket(TypedDict, total=False):
    ...
    jurisdiction: Literal["eu", "fedramp", "fedramp-high", "us"]
    """
    The
...
class SettingsExportsWorkersWorkerExportCache(TypedDict, total=False):
...
class SettingsExportsWorkersWorkerExport(TypedDict, total=False):
    ...
    cache: SettingsExportsWorkersWorkerExportCache
    """Cache override for this entrypoint.
...
class SettingsExportsWorkersDurableObjectExport(TypedDict, total=False):
...
class SettingsExportsWorkersDurableObjectDeletedExport(TypedDict, total=False):
    """
...
class SettingsExportsWorkersDurableObjectRenamedExport(TypedDict, total=False):
    """
...
class SettingsExportsWorkersDurableObjectTransferredExport(TypedDict, total=False):
    """
...
class SettingsExportsWorkersDurableObjectExpectingTransferExport(TypedDict, total=False):
...
SettingsExports: TypeAlias = Union[
    SettingsExportsWorkersWorkerExport,
    SettingsExportsWorkersDurableObjectExport,
    SettingsExportsWorkersDurableObjectDeletedExport,
    SettingsExportsWorkersDurableObjectRenamedExport,
