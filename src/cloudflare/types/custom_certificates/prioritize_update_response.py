...
__all__ = [
    ...
    "PrioritizeUpdateResponseItem",
    "PrioritizeUpdateResponseItemGeoRestrictions",
    "PrioritizeUpdateResponseItemKeylessServer",
    "PrioritizeUpdateResponseItemKeylessServerTunnel",
]


class PrioritizeUpdateResponseItemGeoRestrictions(BaseModel):
    label: Optional[Literal["us", "eu", "highest_security"]] = None


class PrioritizeUpdateResponseItemKeylessServerTunnel(BaseModel):
    private_ip: str
...
class PrioritizeUpdateResponseItemKeylessServer(BaseModel):
    id: str
    ...
    tunnel: Optional[PrioritizeUpdateResponseItemKeylessServerTunnel] = None
    """Configuration for using Keyless SSL through a Cloudflare Tunnel"""


class PrioritizeUpdateResponseItem(BaseModel):
    id: str
    """Identifier"""
    ...
    geo_restrictions: Optional[PrioritizeUpdateResponseItemGeoRestrictions] = None
    """
    ...
    keyless_server: Optional[PrioritizeUpdateResponseItemKeylessServer] = None
...
PrioritizeUpdateResponse = List[PrioritizeUpdateResponseItem]
