...
Binding: TypeAlias = Union[KVNamespaceBinding, ServiceBinding, DurableObjectBinding, R2Binding, WorkersQueueBinding, D1Binding, DispatchNamespaceBinding, MTLSCERTBinding]