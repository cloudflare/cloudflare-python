...
__all__ = [
    ...
    "LoadBalancerListResponseItem",
    "LoadBalancerListResponseItemAdaptiveRouting",
    "LoadBalancerListResponseItemLocationStrategy",
    "LoadBalancerListResponseItemRandomSteering",
    "LoadBalancerListResponseItemRule",
    "LoadBalancerListResponseItemRuleFixedResponse",
    "LoadBalancerListResponseItemRuleOverrides",
    "LoadBalancerListResponseItemRuleOverridesAdaptiveRouting",
    "LoadBalancerListResponseItemRuleOverridesLocationStrategy",
    "LoadBalancerListResponseItemRuleOverridesRandomSteering",
    "LoadBalancerListResponseItemRuleOverridesSessionAffinityAttributes",
    "LoadBalancerListResponseItemSessionAffinityAttributes",
]


class LoadBalancerListResponseItemAdaptiveRouting(BaseModel):
...
class LoadBalancerListResponseItemLocationStrategy(BaseModel):
...
class LoadBalancerListResponseItemRandomSteering(BaseModel):
...
class LoadBalancerListResponseItemRuleFixedResponse(BaseModel):
...
class LoadBalancerListResponseItemRuleOverridesAdaptiveRouting(BaseModel):
    failover_across_pools: Optional[bool] = None
    """
    Extends zero-downtime failover of requests to healthy origins from alternate
    pools, when no healthy alternate exists in the same pool, according to the
...
class LoadBalancerListResponseItemRuleOverridesLocationStrategy(BaseModel):
    mode: Optional[Literal["pop", "resolver_ip"]] = None
    """
    Determines the authoritative location when ECS is not preferred, does not exist
    in the request, or its GeoIP lookup is unsuccessful.
...
class LoadBalancerListResponseItemRuleOverridesRandomSteering(BaseModel):
    default_weight: Optional[float] = None
    """
    The default weight for pools in the load balancer that are not specified in the
    pool_weights map.
...
class LoadBalancerListResponseItemRuleOverridesSessionAffinityAttributes(BaseModel):
...
class LoadBalancerListResponseItemRuleOverrides(BaseModel):
    adaptive_routing: Optional[LoadBalancerListResponseItemRuleOverridesAdaptiveRouting] = None
    """
    ...
    location_strategy: Optional[LoadBalancerListResponseItemRuleOverridesLocationStrategy] = None
    ...
    random_steering: Optional[LoadBalancerListResponseItemRuleOverridesRandomSteering] = None
    ...
    session_affinity_attributes: Optional[LoadBalancerListResponseItemRuleOverridesSessionAffinityAttributes] = None
...
class LoadBalancerListResponseItemRule(BaseModel):
    ...
    fixed_response: Optional[LoadBalancerListResponseItemRuleFixedResponse] = None
    """
    ...
    overrides: Optional[LoadBalancerListResponseItemRuleOverrides] = None
    """
...
class LoadBalancerListResponseItemSessionAffinityAttributes(BaseModel):
    drain_duration: Optional[float] = None
    """Configures the drain duration in seconds.
...
class LoadBalancerListResponseItem(BaseModel):
    id: Optional[str] = None

    adaptive_routing: Optional[LoadBalancerListResponseItemAdaptiveRouting] = None
    """
    Controls features that modify the routing of requests to pools and origins in
    response to dynamic conditions, such as during the interval between active
    health monitoring requests. For example, zero-downtime failover occurs
    ...
    location_strategy: Optional[LoadBalancerListResponseItemLocationStrategy] = None
    """Controls location-based steering for non-proxied requests.
    ...
    random_steering: Optional[LoadBalancerListResponseItemRandomSteering] = None
    """Configures pool weights.
    ...
    rules: Optional[List[LoadBalancerListResponseItemRule]] = None
    """
    ...
    session_affinity_attributes: Optional[LoadBalancerListResponseItemSessionAffinityAttributes] = None
    """Configures attributes for session affinity."""
...
LoadBalancerListResponse = List[LoadBalancerListResponseItem]
