...
class LiveInput(BaseModel):
    ...
    status: Optional[Literal["connected", "reconnected", "reconnecting", "client_disconnect", "ttl_exceeded", "failed_to_connect", "failed_to_reconnect", "new_configuration_accepted"]] = None
