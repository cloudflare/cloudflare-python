...
__all__ = [
    ...
    "WatermarkStreamWatermarkProfileListWatermarkProfilesResponseItem",
]


class WatermarkStreamWatermarkProfileListWatermarkProfilesResponseItem(BaseModel):
...
WatermarkStreamWatermarkProfileListWatermarkProfilesResponse = List[
    WatermarkStreamWatermarkProfileListWatermarkProfilesResponseItem
]
