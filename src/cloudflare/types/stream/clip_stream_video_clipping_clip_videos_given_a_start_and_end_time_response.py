...
__all__ = ["ClipStreamVideoClippingClipVideosGivenAStartAndEndTimeResponse", "Playback", "Watermark"]
...
class ClipStreamVideoClippingClipVideosGivenAStartAndEndTimeResponse(BaseModel):
