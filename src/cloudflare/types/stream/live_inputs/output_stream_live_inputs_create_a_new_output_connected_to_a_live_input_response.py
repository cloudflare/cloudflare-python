...
__all__ = ["OutputStreamLiveInputsCreateANewOutputConnectedToALiveInputResponse"]


class OutputStreamLiveInputsCreateANewOutputConnectedToALiveInputResponse(BaseModel):
