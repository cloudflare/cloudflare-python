...
__all__ = [
    ...
    "OutputStreamLiveInputsListAllOutputsAssociatedWithASpecifiedLiveInputResponseItem",
]


class OutputStreamLiveInputsListAllOutputsAssociatedWithASpecifiedLiveInputResponseItem(BaseModel):
...
OutputStreamLiveInputsListAllOutputsAssociatedWithASpecifiedLiveInputResponse = List[
    OutputStreamLiveInputsListAllOutputsAssociatedWithASpecifiedLiveInputResponseItem
]
