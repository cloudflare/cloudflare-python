...
__all__ = ["RouteTunnelRouteListTunnelRoutesResponse", "RouteTunnelRouteListTunnelRoutesResponseItem"]


class RouteTunnelRouteListTunnelRoutesResponseItem(BaseModel):
...
RouteTunnelRouteListTunnelRoutesResponse = List[RouteTunnelRouteListTunnelRoutesResponseItem]
