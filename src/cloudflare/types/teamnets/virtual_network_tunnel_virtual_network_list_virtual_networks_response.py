...
__all__ = [
    ...
    "VirtualNetworkTunnelVirtualNetworkListVirtualNetworksResponseItem",
]


class VirtualNetworkTunnelVirtualNetworkListVirtualNetworksResponseItem(BaseModel):
    id: str
...
VirtualNetworkTunnelVirtualNetworkListVirtualNetworksResponse = List[
    VirtualNetworkTunnelVirtualNetworkListVirtualNetworksResponseItem
]
