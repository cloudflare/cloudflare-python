...
__all__ = ["SummaryResponseCodesResponse", "Meta", "MetaDateRange", "MetaConfidenceInfo", "MetaConfidenceInfoAnnotation", "Summary0"]
...
class Summary0(BaseModel):
    ...
    nxdomain: str = FieldInfo(alias = "NXDOMAIN")

    refused: str = FieldInfo(alias = "REFUSED")

    servfail: str = FieldInfo(alias = "SERVFAIL")
