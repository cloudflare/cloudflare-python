...
__all__ = ["Layer7TimeseriesParams"]

class Layer7TimeseriesParams(TypedDict, total=False):
    ...
    attack: List[Literal["DDOS", "WAF", "BOT_MANAGEMENT", "ACCESS_RULES", "IP_REPUTATION", "API_SHIELD", "DATA_LOSS_PREVENTION"]]
