...
__all__ = ["SummaryHTTPMethodResponse", "Meta", "MetaDateRange", "MetaConfidenceInfo", "MetaConfidenceInfoAnnotation", "Summary0"]
...
class Summary0(BaseModel):
    get: str = FieldInfo(alias = "GET")

    post: str = FieldInfo(alias = "POST")
