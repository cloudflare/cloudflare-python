...
__all__ = ["ClientCertificateClientCertificateForAZoneCreateClientCertificateResponse", "CertificateAuthority"]
...
class ClientCertificateClientCertificateForAZoneCreateClientCertificateResponse(BaseModel):
    id: Optional[str] = None
    """Identifier"""
