...
__all__ = [
    "StreamListResponse",
    "StreamListResponseItem",
    "StreamListResponseItemInput",
    "StreamListResponseItemPlayback",
    "StreamListResponseItemStatus",
    "StreamListResponseItemWatermark",
]


class StreamListResponseItemInput(BaseModel):
...
class StreamListResponseItemPlayback(BaseModel):
...
class StreamListResponseItemStatus(BaseModel):
...
class StreamListResponseItemWatermark(BaseModel):
...
class StreamListResponseItem(BaseModel):
    ...
    input: Optional[StreamListResponseItemInput] = None
    ...
    playback: Optional[StreamListResponseItemPlayback] = None
    ...
    status: Optional[StreamListResponseItemStatus] = None
    ...
    watermark: Optional[StreamListResponseItemWatermark] = None


StreamListResponse = List[StreamListResponseItem]
