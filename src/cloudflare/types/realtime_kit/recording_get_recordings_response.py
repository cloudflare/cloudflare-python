...
__all__ = [
    ...
    "DataMeetingRecordingConfigStorageConfigUnionMember0",
    "DataMeetingRecordingConfigStorageConfigUnionMember1",
    "DataMeetingRecordingConfigStorageConfigUnionMember2",
    "DataMeetingRecordingConfigStorageConfigUnionMember3",
...
class DataMeetingRecordingConfigStorageConfigUnionMember0(BaseModel):
...
class DataMeetingRecordingConfigStorageConfigUnionMember1(BaseModel):
    access_key: object
...
class DataMeetingRecordingConfigStorageConfigUnionMember2(BaseModel):
...
class DataMeetingRecordingConfigStorageConfigUnionMember3(BaseModel):
...
DataMeetingRecordingConfigStorageConfig: TypeAlias = Union[
    DataMeetingRecordingConfigStorageConfigUnionMember0,
    DataMeetingRecordingConfigStorageConfigUnionMember1,
    DataMeetingRecordingConfigStorageConfigUnionMember2,
    DataMeetingRecordingConfigStorageConfigUnionMember3,
...
class DataMeetingRecordingConfigVideoConfig(BaseModel):
    codec: Optional[Literal["H264", "VP8", "VP9"]] = None
    """Codec using which the recording will be encoded."""
