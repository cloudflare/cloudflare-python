...
__all__ = ["SubscriptionZoneSubscriptionUpdateZoneSubscriptionParams", "App", "ComponentValue", "RatePlan", "Zone"]


class SubscriptionZoneSubscriptionUpdateZoneSubscriptionParams(TypedDict, total=False):
    app: App
