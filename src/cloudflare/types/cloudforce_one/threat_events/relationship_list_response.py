...
__all__ = ["RelationshipListResponse", "RelationshipListResponseItem"]


class RelationshipListResponseItem(BaseModel):
    attacker: str
...
RelationshipListResponse: TypeAlias = List[RelationshipListResponseItem]
