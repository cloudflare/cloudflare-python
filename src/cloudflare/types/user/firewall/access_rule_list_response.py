...
class ConfigurationFirewallIPConfiguration(BaseModel):
...
class ConfigurationFirewallIPV6Configuration(BaseModel):
...
class ConfigurationFirewallCIDRConfiguration(BaseModel):
...
class ConfigurationFirewallASNConfiguration(BaseModel):
...
class ConfigurationFirewallCountryConfiguration(BaseModel):
