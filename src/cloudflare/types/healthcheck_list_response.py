...
__all__ = [
    ...
    "HealthcheckListResponseItemHTTPConfig",
    "HealthcheckListResponseItemTcpConfig",
]


class HealthcheckListResponseItemHTTPConfig(BaseModel):
...
class HealthcheckListResponseItemTcpConfig(BaseModel):
...
class HealthcheckListResponseItem(BaseModel):
    ...
    http_config: Optional[HealthcheckListResponseItemHTTPConfig] = None
    ...
    tcp_config: Optional[HealthcheckListResponseItemTcpConfig] = None
...
HealthcheckListResponse = List[HealthcheckListResponseItem]
