...
__all__ = ["IncomingSecondaryDNSSecondaryZoneUpdateSecondaryZoneConfigurationResponse"]


class IncomingSecondaryDNSSecondaryZoneUpdateSecondaryZoneConfigurationResponse(BaseModel):
