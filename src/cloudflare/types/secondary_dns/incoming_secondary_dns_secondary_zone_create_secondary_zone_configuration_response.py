...
__all__ = ["IncomingSecondaryDNSSecondaryZoneCreateSecondaryZoneConfigurationResponse"]


class IncomingSecondaryDNSSecondaryZoneCreateSecondaryZoneConfigurationResponse(BaseModel):
