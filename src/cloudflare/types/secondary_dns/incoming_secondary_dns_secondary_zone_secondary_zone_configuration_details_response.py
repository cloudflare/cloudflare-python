...
__all__ = ["IncomingSecondaryDNSSecondaryZoneSecondaryZoneConfigurationDetailsResponse"]


class IncomingSecondaryDNSSecondaryZoneSecondaryZoneConfigurationDetailsResponse(BaseModel):
