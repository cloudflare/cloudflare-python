...
__all__ = ["ACLSecondaryDNSACLListACLsResponse", "ACLSecondaryDnsaclListACLsResponseItem"]


class ACLSecondaryDnsaclListACLsResponseItem(BaseModel):
    id: object
...
ACLSecondaryDNSACLListACLsResponse = List[ACLSecondaryDnsaclListACLsResponseItem]
