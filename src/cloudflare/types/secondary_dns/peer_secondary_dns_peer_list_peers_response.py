...
__all__ = ["PeerSecondaryDNSPeerListPeersResponse", "PeerSecondaryDNSPeerListPeersResponseItem"]


class PeerSecondaryDNSPeerListPeersResponseItem(BaseModel):
    id: object
...
PeerSecondaryDNSPeerListPeersResponse = List[PeerSecondaryDNSPeerListPeersResponseItem]
