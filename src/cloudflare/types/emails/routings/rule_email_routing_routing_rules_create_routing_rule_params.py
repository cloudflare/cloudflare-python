...
__all__ = ["RuleEmailRoutingRoutingRulesCreateRoutingRuleParams", "Action", "Matcher"]


class RuleEmailRoutingRoutingRulesCreateRoutingRuleParams(TypedDict, total=False):
