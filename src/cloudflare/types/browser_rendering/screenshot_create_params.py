...
__all__ = [
    ...
    "Variant0Cookie",
    "Variant0GotoOptions",
    "Variant0ScreenshotOptions",
    "Variant0ScreenshotOptionsClip",
    "Variant0Viewport",
    ...
    "Variant1Cookie",
    "Variant1GotoOptions",
    "Variant1ScreenshotOptions",
    "Variant1ScreenshotOptionsClip",
    "Variant1Viewport",
...
class Variant0(TypedDict, total=False):
    ...
    screenshot_options: Annotated[Variant0ScreenshotOptions, PropertyInfo(alias="screenshotOptions")]
...
class Variant0ScreenshotOptionsClip(TypedDict, total=False):
...
class Variant0ScreenshotOptions(TypedDict, total=False):
    """Check [options](https://pptr.dev/api/puppeteer.screenshotoptions)."""

    capture_beyond_viewport: Annotated[bool, PropertyInfo(alias="captureBeyondViewport")]

    clip: Variant0ScreenshotOptionsClip
...
class Variant1(TypedDict, total=False):
    ...
    screenshot_options: Annotated[Variant1ScreenshotOptions, PropertyInfo(alias="screenshotOptions")]
    """Check [options](https://pptr.dev/api/puppeteer.screenshotoptions)."""
...
class Variant1ScreenshotOptionsClip(TypedDict, total=False):
    height: Required[float]
...
class Variant1ScreenshotOptions(TypedDict, total=False):
    """Check [options](https://pptr.dev/api/puppeteer.screenshotoptions)."""

    capture_beyond_viewport: Annotated[bool, PropertyInfo(alias="captureBeyondViewport")]

    clip: Variant1ScreenshotOptionsClip
...
ScreenshotCreateParams: TypeAlias = Union[Variant0, Variant1]
