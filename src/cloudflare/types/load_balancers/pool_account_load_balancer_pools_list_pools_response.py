...
__all__ = [
    ...
    "PoolAccountLoadBalancerPoolsListPoolsResponseItem",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemLoadShedding",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilter",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilterOrigin",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilterPool",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemOriginSteering",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemOrigin",
    "PoolAccountLoadBalancerPoolsListPoolsResponseItemOriginHeader",
]


class PoolAccountLoadBalancerPoolsListPoolsResponseItemLoadShedding(BaseModel):
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilterOrigin(BaseModel):
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilterPool(BaseModel):
    disable: Optional[bool] = None
    """If set true, disable notifications for this type of resource (pool or origin)."""
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilter(BaseModel):
    origin: Optional[PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilterOrigin] = None
    """Filter options for a particular resource type (pool or origin).

    Use null to reset.
    """

    pool: Optional[PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilterPool] = None
    """Filter options for a particular resource type (pool or origin).
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItemOriginSteering(BaseModel):
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItemOriginHeader(BaseModel):
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItemOrigin(BaseModel):
    ...
    header: Optional[PoolAccountLoadBalancerPoolsListPoolsResponseItemOriginHeader] = None
...
class PoolAccountLoadBalancerPoolsListPoolsResponseItem(BaseModel):
    ...
    load_shedding: Optional[PoolAccountLoadBalancerPoolsListPoolsResponseItemLoadShedding] = None
    ...
    notification_filter: Optional[PoolAccountLoadBalancerPoolsListPoolsResponseItemNotificationFilter] = None
    """Filter pool and origin health notifications by resource type or health status.

    Use null to reset.
    """

    origin_steering: Optional[PoolAccountLoadBalancerPoolsListPoolsResponseItemOriginSteering] = None
    ...
    origins: Optional[List[PoolAccountLoadBalancerPoolsListPoolsResponseItemOrigin]] = None
...
PoolAccountLoadBalancerPoolsListPoolsResponse = List[PoolAccountLoadBalancerPoolsListPoolsResponseItem]
