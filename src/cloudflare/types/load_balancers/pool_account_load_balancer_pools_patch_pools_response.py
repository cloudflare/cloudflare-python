...
__all__ = [
    ...
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItem",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemLoadShedding",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilter",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterOrigin",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterPool",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOriginSteering",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOrigin",
    "PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOriginHeader",
]


class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemLoadShedding(BaseModel):
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterOrigin(BaseModel):
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterPool(BaseModel):
    disable: Optional[bool] = None
    """If set true, disable notifications for this type of resource (pool or origin)."""
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilter(BaseModel):
    origin: Optional[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterOrigin] = None
    """Filter options for a particular resource type (pool or origin).

    Use null to reset.
    """

    pool: Optional[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilterPool] = None
    """Filter options for a particular resource type (pool or origin).
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOriginSteering(BaseModel):
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOriginHeader(BaseModel):
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOrigin(BaseModel):
    ...
    header: Optional[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOriginHeader] = None
...
class PoolAccountLoadBalancerPoolsPatchPoolsResponseItem(BaseModel):
    ...
    load_shedding: Optional[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemLoadShedding] = None
    ...
    notification_filter: Optional[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemNotificationFilter] = None
    """Filter pool and origin health notifications by resource type or health status.

    Use null to reset.
    """

    origin_steering: Optional[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOriginSteering] = None
    ...
    origins: Optional[List[PoolAccountLoadBalancerPoolsPatchPoolsResponseItemOrigin]] = None
...
PoolAccountLoadBalancerPoolsPatchPoolsResponse = List[PoolAccountLoadBalancerPoolsPatchPoolsResponseItem]
