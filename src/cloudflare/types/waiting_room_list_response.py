...
__all__ = [
    ...
    "WaitingRoomListResponseItem",
    "WaitingRoomListResponseItemAdditionalRoute",
    "WaitingRoomListResponseItemCookieAttributes",
]


class WaitingRoomListResponseItemAdditionalRoute(BaseModel):
...
class WaitingRoomListResponseItemCookieAttributes(BaseModel):
...
class WaitingRoomListResponseItem(BaseModel):
    id: Optional[object] = None

    additional_routes: Optional[List[WaitingRoomListResponseItemAdditionalRoute]] = None
    ...
    cookie_attributes: Optional[WaitingRoomListResponseItemCookieAttributes] = None
...
WaitingRoomListResponse = List[WaitingRoomListResponseItem]
