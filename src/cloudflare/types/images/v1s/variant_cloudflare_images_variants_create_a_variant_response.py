...
__all__ = ["VariantCloudflareImagesVariantsCreateAVariantResponse", "Variant", "VariantOptions"]
...
class VariantCloudflareImagesVariantsCreateAVariantResponse(BaseModel):
