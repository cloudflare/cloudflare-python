...
__all__ = ["VariantCloudflareImagesVariantsListVariantsResponse", "Variants", "VariantsHero", "VariantsHeroOptions"]
...
class VariantCloudflareImagesVariantsListVariantsResponse(BaseModel):
