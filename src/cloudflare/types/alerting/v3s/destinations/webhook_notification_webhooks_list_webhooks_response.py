...
__all__ = ["WebhookNotificationWebhooksListWebhooksResponse", "WebhookNotificationWebhooksListWebhooksResponseItem"]


class WebhookNotificationWebhooksListWebhooksResponseItem(BaseModel):
...
WebhookNotificationWebhooksListWebhooksResponse = List[WebhookNotificationWebhooksListWebhooksResponseItem]
