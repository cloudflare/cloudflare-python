...
__all__ = ["HistoryNotificationHistoryListHistoryResponse", "HistoryNotificationHistoryListHistoryResponseItem"]


class HistoryNotificationHistoryListHistoryResponseItem(BaseModel):
...
HistoryNotificationHistoryListHistoryResponse = List[HistoryNotificationHistoryListHistoryResponseItem]
