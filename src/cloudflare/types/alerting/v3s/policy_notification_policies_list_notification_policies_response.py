...
__all__ = [
    ...
    "PolicyNotificationPoliciesListNotificationPoliciesResponseItem",
    "PolicyNotificationPoliciesListNotificationPoliciesResponseItemFilters",
    "PolicyNotificationPoliciesListNotificationPoliciesResponseItemMechanisms",
]


class PolicyNotificationPoliciesListNotificationPoliciesResponseItemFilters(BaseModel):
...
class PolicyNotificationPoliciesListNotificationPoliciesResponseItemMechanisms(BaseModel):
    id: Union[str, str, None] = None
    """UUID"""


class PolicyNotificationPoliciesListNotificationPoliciesResponseItem(BaseModel):
    ...
    filters: Optional[PolicyNotificationPoliciesListNotificationPoliciesResponseItemFilters] = None
    """
    ...
    mechanisms: Optional[
        Dict[str, List[PolicyNotificationPoliciesListNotificationPoliciesResponseItemMechanisms]]
    ] = None
...
PolicyNotificationPoliciesListNotificationPoliciesResponse = List[
    PolicyNotificationPoliciesListNotificationPoliciesResponseItem
]
