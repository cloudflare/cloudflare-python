...
__all__ = ["EventWaitingRoomListEventsResponse", "EventWaitingRoomListEventsResponseItem"]


class EventWaitingRoomListEventsResponseItem(BaseModel):
...
EventWaitingRoomListEventsResponse = List[EventWaitingRoomListEventsResponseItem]
