...
from .unnamed_schema_ref_83 import UnnamedSchemaRef83
from .unnamed_schema_ref_84 import UnnamedSchemaRef84

__all__ = ["UnnamedSchemaRef39", "IPSECTunnel", "IPSECTunnelPSKMetadata", "IPSECTunnelTunnelHealthCheck"]
...
class UnnamedSchemaRef39(BaseModel):
