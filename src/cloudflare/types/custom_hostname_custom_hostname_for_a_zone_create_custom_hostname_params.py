...
__all__ = ["CustomHostnameCustomHostnameForAZoneCreateCustomHostnameParams", "SSL", "SSLSettings", "CustomMetadata"]


class CustomHostnameCustomHostnameForAZoneCreateCustomHostnameParams(TypedDict, total=False):
