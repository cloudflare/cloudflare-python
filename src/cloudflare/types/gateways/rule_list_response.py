...
__all__ = [
    ...
    "RuleListResponseItemRuleSettings",
    "RuleListResponseItemRuleSettingsAuditSSH",
    "RuleListResponseItemRuleSettingsBisoAdminControls",
    "RuleListResponseItemRuleSettingsCheckSession",
    "RuleListResponseItemRuleSettingsDNSResolvers",
    "RuleListResponseItemRuleSettingsDNSResolversIPV4",
    "RuleListResponseItemRuleSettingsDNSResolversIPV6",
    "RuleListResponseItemRuleSettingsEgress",
    "RuleListResponseItemRuleSettingsL4override",
    "RuleListResponseItemRuleSettingsNotificationSettings",
    "RuleListResponseItemRuleSettingsPayloadLog",
    "RuleListResponseItemRuleSettingsUntrustedCert",
    "RuleListResponseItemSchedule",
]


class RuleListResponseItemRuleSettingsAuditSSH(BaseModel):
    command_logging: Optional[bool] = None
    """Enable to turn on SSH command logging."""


class RuleListResponseItemRuleSettingsBisoAdminControls(BaseModel):
...
class RuleListResponseItemRuleSettingsCheckSession(BaseModel):
...
class RuleListResponseItemRuleSettingsDNSResolversIPV4(BaseModel):
    ip: str
...
class RuleListResponseItemRuleSettingsDNSResolversIPV6(BaseModel):
    ip: str
    """IP address of upstream resolver."""
...
class RuleListResponseItemRuleSettingsDNSResolvers(BaseModel):
    ipv4: Optional[List[RuleListResponseItemRuleSettingsDNSResolversIPV4]] = None

    ipv6: Optional[List[RuleListResponseItemRuleSettingsDNSResolversIPV6]] = None


class RuleListResponseItemRuleSettingsEgress(BaseModel):
...
class RuleListResponseItemRuleSettingsL4override(BaseModel):
...
class RuleListResponseItemRuleSettingsNotificationSettings(BaseModel):
...
class RuleListResponseItemRuleSettingsPayloadLog(BaseModel):
    enabled: Optional[bool] = None
    """Set to true to enable DLP payload logging for this rule."""


class RuleListResponseItemRuleSettingsUntrustedCert(BaseModel):
...
class RuleListResponseItemRuleSettings(BaseModel):
    ...
    audit_ssh: Optional[RuleListResponseItemRuleSettingsAuditSSH] = None
    """Settings for the Audit SSH action."""

    biso_admin_controls: Optional[RuleListResponseItemRuleSettingsBisoAdminControls] = None
    ...
    check_session: Optional[RuleListResponseItemRuleSettingsCheckSession] = None
    """Configure how session check behaves."""

    dns_resolvers: Optional[RuleListResponseItemRuleSettingsDNSResolvers] = None
    ...
    egress: Optional[RuleListResponseItemRuleSettingsEgress] = None
    ...
    l4override: Optional[RuleListResponseItemRuleSettingsL4override] = None
    """Send matching traffic to the supplied destination IP address and port."""

    notification_settings: Optional[RuleListResponseItemRuleSettingsNotificationSettings] = None
    """
    ...
    payload_log: Optional[RuleListResponseItemRuleSettingsPayloadLog] = None
    ...
    untrusted_cert: Optional[RuleListResponseItemRuleSettingsUntrustedCert] = None
    """Configure behavior when an upstream cert is invalid or an SSL error occurs."""


class RuleListResponseItemSchedule(BaseModel):
...
class RuleListResponseItem(BaseModel):
    ...
    rule_settings: Optional[RuleListResponseItemRuleSettings] = None
    """Additional settings that modify the rule's action."""

    schedule: Optional[RuleListResponseItemSchedule] = None
