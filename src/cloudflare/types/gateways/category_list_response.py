...
__all__ = ["CategoryListResponse", "CategoryListResponseItem", "CategoryListResponseItemSubcategory"]


class CategoryListResponseItemSubcategory(BaseModel):
...
class CategoryListResponseItem(BaseModel):
    ...
    subcategories: Optional[List[CategoryListResponseItemSubcategory]] = None
