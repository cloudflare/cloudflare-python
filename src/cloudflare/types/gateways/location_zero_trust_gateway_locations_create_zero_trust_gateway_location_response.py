...
__all__ = ["LocationZeroTrustGatewayLocationsCreateZeroTrustGatewayLocationResponse", "Network"]
...
class LocationZeroTrustGatewayLocationsCreateZeroTrustGatewayLocationResponse(BaseModel):
