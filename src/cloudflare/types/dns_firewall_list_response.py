...
__all__ = ["DNSFirewallListResponse", "DNSFirewallListResponseItem", "DNSFirewallListResponseItemAttackMitigation"]


class DNSFirewallListResponseItemAttackMitigation(BaseModel):
...
class DNSFirewallListResponseItem(BaseModel):
    id: str
    """Identifier"""
    ...
    attack_mitigation: Optional[DNSFirewallListResponseItemAttackMitigation] = None
...
DNSFirewallListResponse = List[DNSFirewallListResponseItem]
