...
__all__ = [
    "RuleCreateResponse",
    "RuleCreateResponseItem",
    "RuleCreateResponseItemFilter",
    "RuleCreateResponseItemFilterLegacyJhsFilter",
    "RuleCreateResponseItemFilterLegacyJhsDeletedFilter",
]


class RuleCreateResponseItemFilterLegacyJhsFilter(BaseModel):
...
class RuleCreateResponseItemFilterLegacyJhsDeletedFilter(BaseModel):
    id: str
    """The unique identifier of the filter."""
...
class RuleCreateResponseItem(BaseModel):
    ...
    filter: RuleCreateResponseItemFilter
...
RuleCreateResponse = List[RuleCreateResponseItem]
