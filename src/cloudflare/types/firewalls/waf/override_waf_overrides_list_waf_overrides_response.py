...
__all__ = [
    ...
    "OverrideWAFOverridesListWAFOverridesResponseItem",
    "OverrideWAFOverridesListWAFOverridesResponseItemRewriteAction",
]


class OverrideWAFOverridesListWAFOverridesResponseItemRewriteAction(BaseModel):
...
class OverrideWAFOverridesListWAFOverridesResponseItem(BaseModel):
    id: str
    ...
    rewrite_action: Optional[OverrideWAFOverridesListWAFOverridesResponseItemRewriteAction] = None
    """
...
OverrideWAFOverridesListWAFOverridesResponse = List[OverrideWAFOverridesListWAFOverridesResponseItem]
