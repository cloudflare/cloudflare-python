...
class EdgeIPsUnionMember0(BaseModel):
...
class EdgeIPsUnionMember1(BaseModel):
...
class AppSpectrumApplicationsCreateSpectrumApplicationUsingANameForTheOriginResponse(BaseModel):
