...
__all__ = [
    "AppSpectrumApplicationsCreateSpectrumApplicationUsingANameForTheOriginParams",
    "DNS",
    "OriginDNS",
    "EdgeIPs",
    "EdgeIPsUnionMember0",
...
class AppSpectrumApplicationsCreateSpectrumApplicationUsingANameForTheOriginParams(TypedDict, total=False):
    dns: Required[DNS]
...
class EdgeIPsUnionMember0(TypedDict, total=False):
...
class EdgeIPsUnionMember1(TypedDict, total=False):
    ips: List[str]
    """
...
EdgeIPs = Union[EdgeIPsUnionMember0, EdgeIPsUnionMember1]
