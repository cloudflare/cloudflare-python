...
__all__ = [
    "ConfigurationCloudflareTunnelConfigurationPutConfigurationParams",
    "Config",
    "ConfigIngress",
...
class ConfigurationCloudflareTunnelConfigurationPutConfigurationParams(TypedDict, total=False):
