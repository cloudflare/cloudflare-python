...
__all__ = ["OrganizationZeroTrustOrganizationGetYourZeroTrustOrganizationResponse", "CustomPages", "LoginDesign"]
...
class OrganizationZeroTrustOrganizationGetYourZeroTrustOrganizationResponse(BaseModel):
