...
__all__ = ["OrganizationZeroTrustOrganizationCreateYourZeroTrustOrganizationParams", "LoginDesign"]


class OrganizationZeroTrustOrganizationCreateYourZeroTrustOrganizationParams(TypedDict, total=False):
