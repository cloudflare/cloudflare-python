...
__all__ = ["OrganizationZeroTrustOrganizationUpdateYourZeroTrustOrganizationParams", "CustomPages", "LoginDesign"]


class OrganizationZeroTrustOrganizationUpdateYourZeroTrustOrganizationParams(TypedDict, total=False):
