...
__all__ = ["OrganizationZeroTrustOrganizationCreateYourZeroTrustOrganizationResponse", "CustomPages", "LoginDesign"]
...
class OrganizationZeroTrustOrganizationCreateYourZeroTrustOrganizationResponse(BaseModel):
