...
__all__ = ["OrganizationZeroTrustOrganizationUpdateYourZeroTrustOrganizationResponse", "CustomPages", "LoginDesign"]
...
class OrganizationZeroTrustOrganizationUpdateYourZeroTrustOrganizationResponse(BaseModel):
