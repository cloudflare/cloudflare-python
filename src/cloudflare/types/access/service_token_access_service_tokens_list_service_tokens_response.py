...
__all__ = [
    ...
    "ServiceTokenAccessServiceTokensListServiceTokensResponseItem",
]


class ServiceTokenAccessServiceTokensListServiceTokensResponseItem(BaseModel):
...
ServiceTokenAccessServiceTokensListServiceTokensResponse = List[
    ServiceTokenAccessServiceTokensListServiceTokensResponseItem
]
