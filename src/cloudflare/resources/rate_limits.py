...
class RateLimitsResource(SyncAPIResource):
    ...
    @typing_extensions.deprecated("Rate limiting API is deprecated in favour of using the Ruleset Engine. See https://developers.cloudflare.com/fundamentals/api/reference/deprecations/#rate-limiting-api-previous-version for full details.")
    def create(self,
    zone_identifier: str,
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitCreateResponse:
        ...
        return cast(RateLimitCreateResponse, self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RateLimitCreateResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RateLimitCreateResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncV4PagePaginationArray[RateLimit]:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitDeleteResponse:
        """
        ...
        return self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RateLimitDeleteResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitEditResponse:
        """
        ...
        return cast(RateLimitEditResponse, self._put(
            f"/zones/{zone_identifier}/rate_limits/{id}",
            body=maybe_transform({
                "action": action,
                "match": match,
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RateLimitEditResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RateLimitEditResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitGetResponse:
        """
        ...
        return cast(RateLimitGetResponse, self._get(
            f"/zones/{zone_identifier}/rate_limits/{id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RateLimitGetResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RateLimitGetResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
...
class AsyncRateLimitsResource(AsyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitCreateResponse:
        ...
        return cast(RateLimitCreateResponse, await self._post(
            f"/zones/{zone_identifier}/rate_limits",
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[RateLimit, AsyncV4PagePaginationArray[RateLimit]]:
        """
        Fetches the rate limits for a zone.
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitEditResponse:
        ...
        return cast(RateLimitEditResponse, await self._put(
            f"/zones/{zone_identifier}/rate_limits/{id}",
            body=await async_maybe_transform({
                "action": action,
                "match": match,
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RateLimitGetResponse:
        ...
        return cast(RateLimitGetResponse, await self._get(
            f"/zones/{zone_identifier}/rate_limits/{id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RateLimitGetResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RateLimitGetResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
