...
class OSResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> OSGetResponse:
        """
        ...
        if not os:
          raise ValueError(
            f'Expected a non-empty value for `os` but received {os!r}'
          )
        return self._get(
            ...
            }, os_get_params.OSGetParams), post_parser=ResultWrapper[OSGetResponse]._unwrapper),
