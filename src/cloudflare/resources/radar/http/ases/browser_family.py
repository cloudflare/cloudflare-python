    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> BrowserFamilyGetResponse:
        ...
        if not browser_family:
          raise ValueError(
            f'Expected a non-empty value for `browser_family` but received {browser_family!r}'
          )
        return self._get(
            ...
            }, browser_family_get_params.BrowserFamilyGetParams), post_parser=ResultWrapper[BrowserFamilyGetResponse]._unwrapper),
