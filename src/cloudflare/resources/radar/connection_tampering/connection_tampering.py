...
from ....types.radar import ConnectionTamperingSummaryResponse
...
from ....types.radar import connection_tampering_summary_params
...
class ConnectionTamperingWithRawResponse:
    ...
    def timeseries_groups(self) -> TimeseriesGroupsWithRawResponse:
        return TimeseriesGroupsWithRawResponse(self._connection_tampering.timeseries_groups)
...
class AsyncConnectionTamperingWithRawResponse:
    ...
    def timeseries_groups(self) -> AsyncTimeseriesGroupsWithRawResponse:
        return AsyncTimeseriesGroupsWithRawResponse(self._connection_tampering.timeseries_groups)
...
class ConnectionTamperingWithStreamingResponse:
    ...
    def timeseries_groups(self) -> TimeseriesGroupsWithStreamingResponse:
        return TimeseriesGroupsWithStreamingResponse(self._connection_tampering.timeseries_groups)
...
class AsyncConnectionTamperingWithStreamingResponse:
    ...
    def timeseries_groups(self) -> AsyncTimeseriesGroupsWithStreamingResponse:
        return AsyncTimeseriesGroupsWithStreamingResponse(self._connection_tampering.timeseries_groups)
