...
from ...types.radar.dataset_get_response import DatasetGetResponse
...
from ...types.radar import dataset_download_params
...
class DatasetsResource(SyncAPIResource):
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> DatasetListResponse:
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "limit": limit,
                "offset": offset,
            }, dataset_list_params.DatasetListParams), post_parser=ResultWrapper[DatasetListResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> DatasetDownloadResponse:
        """
        ...
        return self._post(
            ...
            }, dataset_download_params.DatasetDownloadParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "format": format
            }, dataset_download_params.DatasetDownloadParams), post_parser=ResultWrapper[DatasetDownloadResponse]._unwrapper),
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> str:
        ...
        if not alias:
          raise ValueError(
            f'Expected a non-empty value for `alias` but received {alias!r}'
          )
