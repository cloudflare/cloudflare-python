...
from .....types.radar.email.security.timeseries_group_threat_category_response import TimeseriesGroupThreatCategoryResponse
...
class TimeseriesGroupsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupARCResponse:
        """
        ...
        return self._get(
            ...
            }, timeseries_group_arc_params.TimeseriesGroupARCParams), post_parser=ResultWrapper[TimeseriesGroupARCResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupDKIMResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "spf": spf,
                "tls_version": tls_version,
            }, timeseries_group_dkim_params.TimeseriesGroupDKIMParams), post_parser=ResultWrapper[TimeseriesGroupDKIMResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupDMARCResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "spf": spf,
                "tls_version": tls_version,
            }, timeseries_group_dmarc_params.TimeseriesGroupDMARCParams), post_parser=ResultWrapper[TimeseriesGroupDMARCResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupMaliciousResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "spf": spf,
                "tls_version": tls_version,
            }, timeseries_group_malicious_params.TimeseriesGroupMaliciousParams), post_parser=ResultWrapper[TimeseriesGroupMaliciousResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupSpamResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "spf": spf,
                "tls_version": tls_version,
            }, timeseries_group_spam_params.TimeseriesGroupSpamParams), post_parser=ResultWrapper[TimeseriesGroupSpamResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupSPFResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tls_version": tls_version,
            }, timeseries_group_spf_params.TimeseriesGroupSPFParams), post_parser=ResultWrapper[TimeseriesGroupSPFResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupSpoofResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "spf": spf,
                "tls_version": tls_version,
            }, timeseries_group_spoof_params.TimeseriesGroupSpoofParams), post_parser=ResultWrapper[TimeseriesGroupSpoofResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupThreatCategoryResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "spf": spf,
                "tls_version": tls_version,
            }, timeseries_group_threat_category_params.TimeseriesGroupThreatCategoryParams), post_parser=ResultWrapper[TimeseriesGroupThreatCategoryResponse]._unwrapper),
            cast_to=cast(Type[TimeseriesGroupThreatCategoryResponse], ResultWrapper[TimeseriesGroupThreatCategoryResponse]),
        )
