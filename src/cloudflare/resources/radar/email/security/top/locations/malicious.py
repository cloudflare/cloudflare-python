...
from .......types.radar.email.security.top.locations import MaliciousGetResponse, malicious_get_params
...
class Malicious(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            f"/radar/email/security/top/locations/malicious/{malicious}",
