...
from .......types.radar.email.security.top import AseGetResponse, ase_get_params
...
class AsesWithRawResponse:
    ...
    def malicious(self) -> MaliciousWithRawResponse:
        return MaliciousWithRawResponse(self._ases.malicious)

    @cached_property
    def spam(self) -> SpamWithRawResponse:
        return SpamWithRawResponse(self._ases.spam)

    @cached_property
    def spf(self) -> SPFWithRawResponse:
        return SPFWithRawResponse(self._ases.spf)
...
class AsyncAsesWithRawResponse:
    ...
    def malicious(self) -> AsyncMaliciousWithRawResponse:
        return AsyncMaliciousWithRawResponse(self._ases.malicious)

    @cached_property
    def spam(self) -> AsyncSpamWithRawResponse:
        return AsyncSpamWithRawResponse(self._ases.spam)

    @cached_property
    def spf(self) -> AsyncSPFWithRawResponse:
        return AsyncSPFWithRawResponse(self._ases.spf)
...
class AsesWithStreamingResponse:
    ...
    def malicious(self) -> MaliciousWithStreamingResponse:
        return MaliciousWithStreamingResponse(self._ases.malicious)

    @cached_property
    def spam(self) -> SpamWithStreamingResponse:
        return SpamWithStreamingResponse(self._ases.spam)

    @cached_property
    def spf(self) -> SPFWithStreamingResponse:
        return SPFWithStreamingResponse(self._ases.spf)
...
class AsyncAsesWithStreamingResponse:
    ...
    def malicious(self) -> AsyncMaliciousWithStreamingResponse:
        return AsyncMaliciousWithStreamingResponse(self._ases.malicious)

    @cached_property
    def spam(self) -> AsyncSpamWithStreamingResponse:
        return AsyncSpamWithStreamingResponse(self._ases.spam)

    @cached_property
    def spf(self) -> AsyncSPFWithStreamingResponse:
        return AsyncSPFWithStreamingResponse(self._ases.spf)
