...
class SpamResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SpamGetResponse:
        """
        ...
        if not spam:
          raise ValueError(
            f'Expected a non-empty value for `spam` but received {spam!r}'
          )
        return self._get(
            ...
            }, spam_get_params.SpamGetParams), post_parser=ResultWrapper[SpamGetResponse]._unwrapper),
