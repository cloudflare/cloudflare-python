...
from ......types.radar.email.security.summaries import MaliciousListResponse
...
from ......types.radar.email.security.summaries import malicious_list_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    malicious_list_params.MaliciousListParams,
                ),
                post_parser=ResultWrapper._unwrapper,
            ),
            cast_to=cast(Type[MaliciousListResponse], ResultWrapper[MaliciousListResponse]),
        )
