...
from .....types.radar.emails.security import SpamListResponse
...
from .....types.radar.emails.security import spam_list_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    spam_list_params.SpamListParams,
                ),
                post_parser=ResultWrapper._unwrapper,
            ),
            cast_to=cast(Type[SpamListResponse], ResultWrapper[SpamListResponse]),
        )
