...
from .......types.radar.emails.security.top.ases import ArcGetResponse
...
from .......types.radar.emails.security.top.ases import arc_get_params
...
class Arc(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            f"/radar/email/security/top/ases/arc/{arc}",
