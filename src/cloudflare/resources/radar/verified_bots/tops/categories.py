...
from .....types.radar.verified_bots.tops import CategoryListResponse
...
from .....types.radar.verified_bots.tops import category_list_params
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=cast(Type[CategoryListResponse], ResultWrapper[CategoryListResponse]),
        )
