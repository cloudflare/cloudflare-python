...
class TimeseriesGroupsResource(SyncAPIResource):
    ...
    def summary(
        ...
        *,
        ...
        crawl_purpose: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
        ...
        industry: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
        ...
        vertical: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
    ...
    def timeseries(
        ...
        *,
        ...
        location: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
        name: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
        user_agent: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
        vertical: SequenceNotStr[str] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
