...
from .....types.radar.attacks.layer7.timeseries_group_mitigation_product_response import TimeseriesGroupMitigationProductResponse
...
class TimeseriesGroupsResource(SyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupHTTPMethodResponse:
        """
        ...
        return self._get(
            ...
            }, timeseries_group_http_method_params.TimeseriesGroupHTTPMethodParams), post_parser=ResultWrapper[TimeseriesGroupHTTPMethodResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupManagedRulesResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "normalization": normalization,
            }, timeseries_group_managed_rules_params.TimeseriesGroupManagedRulesParams), post_parser=ResultWrapper[TimeseriesGroupManagedRulesResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> TimeseriesGroupMitigationProductResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "normalization": normalization,
            }, timeseries_group_mitigation_product_params.TimeseriesGroupMitigationProductParams), post_parser=ResultWrapper[TimeseriesGroupMitigationProductResponse]._unwrapper),
            cast_to=cast(Type[TimeseriesGroupMitigationProductResponse], ResultWrapper[TimeseriesGroupMitigationProductResponse]),
        )
