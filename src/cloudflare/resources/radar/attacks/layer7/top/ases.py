...
class AsesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AseOriginResponse:
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
            }, ase_origin_params.AseOriginParams), post_parser=ResultWrapper[AseOriginResponse]._unwrapper),
