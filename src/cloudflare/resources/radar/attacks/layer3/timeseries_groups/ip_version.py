...
from ......types.radar.attacks.layer3.timeseries_groups import IPVersionListResponse
...
from ......types.radar.attacks.layer3.timeseries_groups import ip_version_list_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    ip_version_list_params.IPVersionListParams,
                ),
                post_parser=ResultWrapper._unwrapper,
            ),
            cast_to=cast(Type[IPVersionListResponse], ResultWrapper[IPVersionListResponse]),
        )
