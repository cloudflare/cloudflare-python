...
from .....types.radar.as112.timeseries_groups import DNSSECListResponse, dnssec_list_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    dnssec_list_params.DNSSECListParams,
                ),
                post_parser=ResultWrapper._unwrapper,
            ),
            cast_to=cast(Type[DNSSECListResponse], ResultWrapper[DNSSECListResponse]),
        )
