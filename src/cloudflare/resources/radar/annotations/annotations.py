...
from .outages import OutagesResource, AsyncOutagesResource, OutagesResourceWithRawResponse, AsyncOutagesResourceWithRawResponse, OutagesResourceWithStreamingResponse, AsyncOutagesResourceWithStreamingResponse
...
class AnnotationsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AnnotationListResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "location": location,
                "offset": offset,
            }, annotation_list_params.AnnotationListParams), post_parser=ResultWrapper[AnnotationListResponse]._unwrapper),
