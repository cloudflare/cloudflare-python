...
from ....types.radar.dns import summary_cache_hit_params
from ....types.radar.dns import summary_dnssec_params
from ....types.radar.dns import summary_dnssec_aware_params
from ....types.radar.dns import summary_dnssec_e2e_params
from ....types.radar.dns import summary_ip_version_params
from ....types.radar.dns import summary_matching_answer_params
from ....types.radar.dns import summary_protocol_params
from ....types.radar.dns import summary_query_type_params
from ....types.radar.dns import summary_response_codes_params
...
class SummaryResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryCacheHitResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_cache_hit_params.SummaryCacheHitParams), post_parser=ResultWrapper[SummaryCacheHitResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryDNSSECResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_dnssec_params.SummaryDNSSECParams), post_parser=ResultWrapper[SummaryDNSSECResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryDNSSECAwareResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_dnssec_aware_params.SummaryDNSSECAwareParams), post_parser=ResultWrapper[SummaryDNSSECAwareResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryDNSSECE2EResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_dnssec_e2e_params.SummaryDNSSECE2EParams), post_parser=ResultWrapper[SummaryDNSSECE2EResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryMatchingAnswerResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_matching_answer_params.SummaryMatchingAnswerParams), post_parser=ResultWrapper[SummaryMatchingAnswerResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryProtocolResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_protocol_params.SummaryProtocolParams), post_parser=ResultWrapper[SummaryProtocolResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryQueryTypeResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_query_type_params.SummaryQueryTypeParams), post_parser=ResultWrapper[SummaryQueryTypeResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SummaryResponseCodesResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "name": name,
                "tld": tld,
            }, summary_response_codes_params.SummaryResponseCodesParams), post_parser=ResultWrapper[SummaryResponseCodesResponse]._unwrapper),
