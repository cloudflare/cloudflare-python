...
from ...types.firewalls import lockdown_update_params
from ...types.firewalls import lockdown_zone_lockdown_create_a_zone_lockdown_rule_params
from ...types.firewalls import lockdown_zone_lockdown_list_zone_lockdown_rules_params
