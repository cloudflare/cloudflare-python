...
from ....types.zero_trust.access import bookmark_create_params
from ....types.zero_trust.access import bookmark_update_params
...
class BookmarksResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[Bookmark]:
        """
        ...
        if not bookmark_id:
          raise ValueError(
            f'Expected a non-empty value for `bookmark_id` but received {bookmark_id!r}'
          )
        return self._post(
            f"/accounts/{account_id}/access/bookmarks/{bookmark_id}",
            body=maybe_transform(body, bookmark_create_params.BookmarkCreateParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[Bookmark]]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncSinglePage[Bookmark]:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[BookmarkDeleteResponse]:
        """
        ...
        return self._delete(
            f"/accounts/{account_id}/access/bookmarks/{bookmark_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[BookmarkDeleteResponse]]._unwrapper),
...
class AsyncBookmarksResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[Bookmark, AsyncSinglePage[Bookmark]]:
        """
        Lists Bookmark applications.
