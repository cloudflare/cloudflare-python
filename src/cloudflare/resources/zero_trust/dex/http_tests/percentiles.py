...
class PercentilesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[HTTPDetailsPercentiles]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "colo": colo,
                "device_id": device_id,
            }, percentile_get_params.PercentileGetParams), post_parser=ResultWrapper[Optional[HTTPDetailsPercentiles]]._unwrapper),
