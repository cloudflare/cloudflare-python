...
class IssuesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncV4PagePagination[IssueListResponse]:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IssueClassResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "subject": subject,
                "subject_neq": subject_neq,
            }, issue_class_params.IssueClassParams), post_parser=ResultWrapper[Optional[IssueClassResponse]]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IssueDismissResponse]:
        """
        ...
        if not issue_id:
          raise ValueError(
            f'Expected a non-empty value for `issue_id` but received {issue_id!r}'
          )
        return cast(Optional[IssueDismissResponse], self._put(
            f"/accounts/{account_id}/intel/attack-surface-report/{issue_id}/dismiss",
            body=maybe_transform({
                "dismiss": dismiss
            }, issue_dismiss_params.IssueDismissParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[IssueDismissResponse]]._unwrapper),
            cast_to=cast(Any, ResultWrapper[IssueDismissResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IssueSeverityResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "subject": subject,
                "subject_neq": subject_neq,
            }, issue_severity_params.IssueSeverityParams), post_parser=ResultWrapper[Optional[IssueSeverityResponse]]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IssueTypeResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "subject": subject,
                "subject_neq": subject_neq,
            }, issue_type_params.IssueTypeParams), post_parser=ResultWrapper[Optional[IssueTypeResponse]]._unwrapper),
...
class AsyncIssuesResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[IssueListResponse, AsyncV4PagePagination[IssueListResponse]]:
        """
        Get Security Center Issues
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IssueDismissResponse]:
        ...
        return cast(Optional[IssueDismissResponse], await self._put(
            f"/accounts/{account_id}/intel/attack-surface-report/{issue_id}/dismiss",
