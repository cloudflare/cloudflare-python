...
class SnapshotsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[SnapshotUpdateResponse]:
        """
        ...
        return self._put(
            ...
            body=maybe_transform({
                "source": source
            }, snapshot_update_params.SnapshotUpdateParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[SnapshotUpdateResponse]]._unwrapper),
