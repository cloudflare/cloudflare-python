...
from ...types.intel import url_get_params
from ..._base_client import make_request_options
from ...types.intel.url import URL
...
class URLsResource(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template("/accounts/{account_id}/intel/url", account_id=account_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"url": url}, url_get_params.URLGetParams),
                post_parser=ResultWrapper[Optional[URL]]._unwrapper,
            ),
            cast_to=cast(Type[Optional[URL]], ResultWrapper[URL]),
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"url": url}, url_get_params.URLGetParams),
                post_parser=ResultWrapper[Optional[URL]]._unwrapper,
            ),
            cast_to=cast(Type[Optional[URL]], ResultWrapper[URL]),
        )
