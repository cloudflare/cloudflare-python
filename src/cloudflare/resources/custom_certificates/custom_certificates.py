...
from .prioritize import PrioritizeResource, AsyncPrioritizeResource
...
from ...types.custom_certificates import custom_certificate_create_params
from ...types.custom_certificates import custom_certificate_list_params
from ...types.custom_certificates import custom_certificate_edit_params
from ...types.custom_hostnames import BundleMethod
from ...types.custom_certificates import GeoRestrictions
from ...types.custom_hostnames import BundleMethod
from ...types.custom_certificates import GeoRestrictions
from .prioritize import PrioritizeResource, AsyncPrioritizeResource, PrioritizeResourceWithRawResponse, AsyncPrioritizeResourceWithRawResponse, PrioritizeResourceWithStreamingResponse, AsyncPrioritizeResourceWithStreamingResponse
...
class CustomCertificatesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[CustomCertificate]:
        """
        ...
        return self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[CustomCertificate]]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncV4PagePaginationArray[CustomCertificate]:
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[CustomCertificateDeleteResponse]:
        """
        ...
        return self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[CustomCertificateDeleteResponse]]._unwrapper),
            cast_to=cast(Type[Optional[CustomCertificateDeleteResponse]], ResultWrapper[CustomCertificateDeleteResponse]),
        )
...
class AsyncCustomCertificatesResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[CustomCertificate, AsyncV4PagePaginationArray[CustomCertificate]]:
        """List, search, and filter all of your custom SSL certificates.
