...
from ....types.zones.settings import EarlyHintGetResponse, EarlyHintEditResponse, early_hint_edit_params
...
class EarlyHints(SyncAPIResource):
    ...
    def edit(
        ...
        *,
    ...
    ) -> Optional[EarlyHintEditResponse]:
        """
        ...
        return self._patch(
            ...
            cast_to=cast(Type[Optional[EarlyHintEditResponse]], ResultWrapper[EarlyHintEditResponse]),
        )
