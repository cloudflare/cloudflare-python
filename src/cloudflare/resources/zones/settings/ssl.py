...
from ....types.zones.settings import SSLGetResponse, SSLEditResponse, ssl_edit_params
    ...
    def edit(
        ...
        *,
        ...
        return self._patch(
            ...
            cast_to=cast(Type[Optional[SSLEditResponse]], ResultWrapper[SSLEditResponse]),
        )
