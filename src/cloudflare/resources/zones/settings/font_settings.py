...
from ....types.zones.settings import FontSettingGetResponse, FontSettingEditResponse, font_setting_edit_params
...
class FontSettings(SyncAPIResource):
    ...
    def edit(
        ...
        *,
    ...
    ) -> Optional[FontSettingEditResponse]:
        ...
        return self._patch(
            ...
            cast_to=cast(Type[Optional[FontSettingEditResponse]], ResultWrapper[FontSettingEditResponse]),
        )
