...
from ....types.zones.settings import PseudoIPV4GetResponse, PseudoIPV4EditResponse, pseudo_ipv4_edit_params
...
class PseudoIPV4(SyncAPIResource):
    ...
    def edit(
        ...
        *,
    ...
    ) -> Optional[PseudoIPV4EditResponse]:
        """
        ...
        return self._patch(
            ...
            cast_to=cast(Type[Optional[PseudoIPV4EditResponse]], ResultWrapper[PseudoIPV4EditResponse]),
        )
