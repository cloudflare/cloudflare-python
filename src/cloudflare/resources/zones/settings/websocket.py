...
from ....types.zones.settings import WebsocketGetResponse, WebsocketEditResponse, websocket_edit_params
...
class Websocket(SyncAPIResource):
    ...
    def edit(
        ...
        *,
    ...
    ) -> Optional[WebsocketEditResponse]:
        ...
        return self._patch(
            ...
            cast_to=cast(Type[Optional[WebsocketEditResponse]], ResultWrapper[WebsocketEditResponse]),
        )
