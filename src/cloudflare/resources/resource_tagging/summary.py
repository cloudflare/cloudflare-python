...
from ...types.resource_tagging import summary_get_params
from ...types.resource_tagging.summary_get_response import SummaryGetResponse
...
class SummaryResource(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template("/accounts/{account_id}/tags/summary", account_id=account_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"cursor": cursor}, summary_get_params.SummaryGetParams),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"cursor": cursor}, summary_get_params.SummaryGetParams),
                post_parser=ResultWrapper[Optional[SummaryGetResponse]]._unwrapper,
            ),
            cast_to=cast(Type[Optional[SummaryGetResponse]], ResultWrapper[SummaryGetResponse]),
        )
