...
from ....types.load_balancers.pools import HealthGetResponse, HealthPreviewResponse
...
from ....types.load_balancers.pools import health_preview_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                health_preview_params.HealthPreviewParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
            ...
            cast_to=cast(Type[HealthPreviewResponse], ResultWrapper[HealthPreviewResponse]),
        )
