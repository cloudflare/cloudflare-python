...
from ....types.load_balancers.pools import PreviewAccountLoadBalancerPoolsPreviewPoolResponse
...
from ....types.load_balancers.pools import preview_account_load_balancer_pools_preview_pool_params
...
class Previews(SyncAPIResource):
    ...
    def account_load_balancer_pools_preview_pool(
        self,
        identifier: str,
        *,
        ...
        return self._post(
            f"/accounts/{account_identifier}/load_balancers/pools/{identifier}/preview",
            body=maybe_transform(
                ...
                preview_account_load_balancer_pools_preview_pool_params.PreviewAccountLoadBalancerPoolsPreviewPoolParams,
            ),
            ...
            cast_to=cast(
                Type[PreviewAccountLoadBalancerPoolsPreviewPoolResponse],
                ResultWrapper[PreviewAccountLoadBalancerPoolsPreviewPoolResponse],
            ),
        )
...
class AsyncPreviews(AsyncAPIResource):
    ...
    async def account_load_balancer_pools_preview_pool(
        self,
        identifier: str,
        *,
        account_identifier: str,
...
class PreviewsWithRawResponse:
    def __init__(self, previews: Previews) -> None:
        ...
        self.account_load_balancer_pools_preview_pool = to_raw_response_wrapper(
            previews.account_load_balancer_pools_preview_pool,
        )
...
class AsyncPreviewsWithRawResponse:
    def __init__(self, previews: AsyncPreviews) -> None:
        ...
        self.account_load_balancer_pools_preview_pool = async_to_raw_response_wrapper(
            previews.account_load_balancer_pools_preview_pool,
        )
...
class PreviewsWithStreamingResponse:
    def __init__(self, previews: Previews) -> None:
        ...
        self.account_load_balancer_pools_preview_pool = to_streamed_response_wrapper(
            previews.account_load_balancer_pools_preview_pool,
        )
...
class AsyncPreviewsWithStreamingResponse:
    def __init__(self, previews: AsyncPreviews) -> None:
        ...
        self.account_load_balancer_pools_preview_pool = async_to_streamed_response_wrapper(
            previews.account_load_balancer_pools_preview_pool,
        )
