...
class SearchesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SearchGetResponse:
        """
        ...
        return self._get(
            ...
            }, search_get_params.SearchGetParams), post_parser=ResultWrapper[SearchGetResponse]._unwrapper),
