...
class RegionsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RegionListResponse:
        """
        ...
        return cast(RegionListResponse, self._get(
            ...
            }, region_list_params.RegionListParams), post_parser=ResultWrapper[RegionListResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RegionListResponse]),  # Union types cannot be passed in as arguments in the type system
        ))

    def get(self,
    region_id: Literal["WNAM", "ENAM", "WEU", "EEU", "NSAM", "SSAM", "OC", "ME", "NAF", "SAF", "SAS", "SEAS", "NEAS"],
    *,
    account_id: str,
    # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    # The extra values given here take precedence over values defined on the client or passed to this method.
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RegionGetResponse:
        """
        ...
        if not region_id:
          raise ValueError(
            f'Expected a non-empty value for `region_id` but received {region_id!r}'
          )
        return cast(RegionGetResponse, self._get(
            f"/accounts/{account_id}/load_balancers/regions/{region_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RegionGetResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RegionGetResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
...
class AsyncRegionsResource(AsyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RegionListResponse:
        ...
        return cast(RegionListResponse, await self._get(
            f"/accounts/{account_id}/load_balancers/regions",
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> RegionGetResponse:
        ...
        return cast(RegionGetResponse, await self._get(
            f"/accounts/{account_id}/load_balancers/regions/{region_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[RegionGetResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[RegionGetResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
