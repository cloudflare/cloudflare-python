...
from ....types.load_balancers.monitors import (
    PreviewAccountLoadBalancerMonitorsPreviewMonitorResponse,
    preview_account_load_balancer_monitors_preview_monitor_params,
)
...
class Previews(SyncAPIResource):
    ...
    def account_load_balancer_monitors_preview_monitor(
        ...
        *,
        ...
        return self._post(
            f"/accounts/{account_identifier}/load_balancers/monitors/{identifier}/preview",
