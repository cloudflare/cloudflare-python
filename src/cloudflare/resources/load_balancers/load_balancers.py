...
class LoadBalancersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        country_pools: load_balancer_create_params.CountryPools | NotGiven = NOT_GIVEN,
        description: str | NotGiven = NOT_GIVEN,
        location_strategy: LocationStrategyParam | NotGiven = NOT_GIVEN,
        pop_pools: load_balancer_create_params.PopPools | NotGiven = NOT_GIVEN,
        proxied: bool | NotGiven = NOT_GIVEN,
        random_steering: RandomSteeringParam | NotGiven = NOT_GIVEN,
        region_pools: load_balancer_create_params.RegionPools | NotGiven = NOT_GIVEN,
    ...
    def update(
        ...
        *,
        ...
        name: str,
        adaptive_routing: AdaptiveRoutingParam | NotGiven = NOT_GIVEN,
        country_pools: load_balancer_update_params.CountryPools | NotGiven = NOT_GIVEN,
        description: str | NotGiven = NOT_GIVEN,
        enabled: bool | NotGiven = NOT_GIVEN,
        location_strategy: LocationStrategyParam | NotGiven = NOT_GIVEN,
        pop_pools: load_balancer_update_params.PopPools | NotGiven = NOT_GIVEN,
        proxied: bool | NotGiven = NOT_GIVEN,
        random_steering: RandomSteeringParam | NotGiven = NOT_GIVEN,
        region_pools: load_balancer_update_params.RegionPools | NotGiven = NOT_GIVEN,
        rules: Iterable[RulesParam] | NotGiven = NOT_GIVEN,
        session_affinity: SessionAffinity | NotGiven = NOT_GIVEN,
        session_affinity_attributes: SessionAffinityAttributesParam | NotGiven = NOT_GIVEN,
        session_affinity_ttl: float | NotGiven = NOT_GIVEN,
    ...
    def edit(
        ...
        *,
        zone_id: str,
        adaptive_routing: AdaptiveRoutingParam | NotGiven = NOT_GIVEN,
        country_pools: load_balancer_edit_params.CountryPools | NotGiven = NOT_GIVEN,
        ...
        pop_pools: load_balancer_edit_params.PopPools | NotGiven = NOT_GIVEN,
        proxied: bool | NotGiven = NOT_GIVEN,
        random_steering: RandomSteeringParam | NotGiven = NOT_GIVEN,
        region_pools: load_balancer_edit_params.RegionPools | NotGiven = NOT_GIVEN,
        rules: Iterable[RulesParam] | NotGiven = NOT_GIVEN,
        session_affinity: SessionAffinity | NotGiven = NOT_GIVEN,
        session_affinity_attributes: SessionAffinityAttributesParam | NotGiven = NOT_GIVEN,
        session_affinity_ttl: float | NotGiven = NOT_GIVEN,
