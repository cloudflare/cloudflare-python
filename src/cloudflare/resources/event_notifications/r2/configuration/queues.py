...
class QueuesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> QueueUpdateResponse:
        """
        ...
        return self._put(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[QueueUpdateResponse]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> QueueDeleteResponse:
        ...
        return cast(QueueDeleteResponse, self._delete(
            f"/accounts/{account_id}/event_notifications/r2/{bucket_name}/configuration/queues/{queue_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[QueueDeleteResponse]._unwrapper),
...
class AsyncQueuesResource(AsyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> QueueDeleteResponse:
        ...
        return cast(QueueDeleteResponse, await self._delete(
            f"/accounts/{account_id}/event_notifications/r2/{bucket_name}/configuration/queues/{queue_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[QueueDeleteResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[QueueDeleteResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
