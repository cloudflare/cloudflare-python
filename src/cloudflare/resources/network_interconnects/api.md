...
- <code title="get /accounts/{account_id}/cni/interconnects/{icon}/loa">client.network_interconnects.interconnects.<a href="./src/cloudflare/resources/network_interconnects/interconnects.py">loa</a>(icon, \*, account_id, \*\*<a href="src/cloudflare/types/network_interconnects/interconnect_loa_params.py">params</a>) -> None</code>
