...
from ...types.brand_protection import SubmitCreateResponse, submit_create_params
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"url": url}, submit_create_params.SubmitCreateParams),
            ...
            cast_to=cast(Type[SubmitCreateResponse], ResultWrapper[SubmitCreateResponse]),
        )
