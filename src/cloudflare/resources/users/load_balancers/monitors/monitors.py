...
from .....types.users.load_balancers import monitor_update_params
from .....types.users.load_balancers import monitor_load_balancer_monitors_create_monitor_params
...
class Monitors(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/user/load_balancers/monitors/{identifier}",
