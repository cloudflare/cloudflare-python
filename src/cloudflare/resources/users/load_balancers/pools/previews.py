...
from .....types.users.load_balancers.pools import PreviewLoadBalancerPoolsPreviewPoolResponse
...
from .....types.users.load_balancers.pools import preview_load_balancer_pools_preview_pool_params
...
class Previews(SyncAPIResource):
    ...
    def load_balancer_pools_preview_pool(
        ...
        *,
        ...
        return self._post(
            f"/user/load_balancers/pools/{identifier}/preview",
