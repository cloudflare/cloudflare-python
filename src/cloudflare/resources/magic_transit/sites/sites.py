...
from .lans import LANsResource, AsyncLANsResource, LANsResourceWithRawResponse, AsyncLANsResourceWithRawResponse, LANsResourceWithStreamingResponse, AsyncLANsResourceWithStreamingResponse
from .wans import WANsResource, AsyncWANsResource, WANsResourceWithRawResponse, AsyncWANsResourceWithRawResponse, WANsResourceWithStreamingResponse, AsyncWANsResourceWithStreamingResponse
...
class SitesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Site:
        """
        Creates a new Site
        ...
        return self._post(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Site]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncSinglePage[Site]:
...
class AsyncSitesResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[Site, AsyncSinglePage[Site]]:
        """Lists Sites associated with an account.
