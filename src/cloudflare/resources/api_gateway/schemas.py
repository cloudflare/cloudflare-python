...
class SchemasResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SchemaListResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "feature": feature,
                "host": host,
            }, schema_list_params.SchemaListParams), post_parser=ResultWrapper[SchemaListResponse]._unwrapper),
