...
class UserSchemasResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SchemaUpload:
        """
        ...
        return self._post(
            ...
            files=files,
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[SchemaUpload]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncV4PagePaginationArray[PublicSchema]:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> UserSchemaDeleteResponse:
        """
        Delete a schema
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> PublicSchema:
        """
        ...
        return self._patch(
            ...
            body=maybe_transform({
                "validation_enabled": validation_enabled
            }, user_schema_edit_params.UserSchemaEditParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[PublicSchema]._unwrapper),
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> PublicSchema:
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "omit_source": omit_source
            }, user_schema_get_params.UserSchemaGetParams), post_parser=ResultWrapper[PublicSchema]._unwrapper),
            cast_to=cast(Type[PublicSchema], ResultWrapper[PublicSchema]),
        )
...
class AsyncUserSchemasResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[PublicSchema, AsyncV4PagePaginationArray[PublicSchema]]:
        """
        Retrieve information about all schemas on a zone
