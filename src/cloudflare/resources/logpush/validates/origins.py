...
from ....types.logpush.validates import OriginPostAccountsAccountIdentifierLogpushValidateOriginResponse
...
from ....types.logpush.validates import origin_post_accounts_account_identifier_logpush_validate_origin_params
