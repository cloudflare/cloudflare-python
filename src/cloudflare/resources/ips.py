...
class IPsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IPListResponse]:
        """
        ...
        """
        return cast(Optional[IPListResponse], self._get(
            "/ips",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "networks": networks
            }, ip_list_params.IPListParams), post_parser=ResultWrapper[Optional[IPListResponse]]._unwrapper),
            cast_to=cast(Any, ResultWrapper[IPListResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[IPListResponse]:
        ...
        Args:
          ...
          timeout: Override the client-level default timeout for this request, in seconds
        """
        return cast(Optional[IPListResponse], await self._get(
            "/ips",
