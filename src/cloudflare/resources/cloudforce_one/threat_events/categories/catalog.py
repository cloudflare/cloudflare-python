...
from .....types.cloudforce_one.threat_events.categories.catalog_list_response import CatalogListResponse
...
class CatalogResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            path_template("/accounts/{account_id}/cloudforce-one/events/categories/catalog", account_id=account_id),
