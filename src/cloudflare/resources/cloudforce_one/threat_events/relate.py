...
from ....types.cloudforce_one.threat_events import relate_update_params
from ....types.cloudforce_one.threat_events.relate_delete_response import RelateDeleteResponse
from ....types.cloudforce_one.threat_events.relate_update_response import RelateUpdateResponse
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"events": events}, relate_update_params.RelateUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                post_parser=ResultWrapper[RelateUpdateResponse]._unwrapper,
            ),
            cast_to=cast(Type[RelateUpdateResponse], ResultWrapper[RelateUpdateResponse]),
        )
    ...
    async def update(
        ...
        *,
        ...
        return await self._post(
            f"/accounts/{account_id}/cloudforce-one/events/relate/{event_id}",
            body=await async_maybe_transform({"events": events}, relate_update_params.RelateUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
