...
class TargetIndustriesResourceWithRawResponse:
    ...
    def by_dataset(self) -> ByDatasetResourceWithRawResponse:
        return ByDatasetResourceWithRawResponse(self._target_industries.by_dataset)

    @cached_property
    def catalog(self) -> CatalogResourceWithRawResponse:
        return CatalogResourceWithRawResponse(self._target_industries.catalog)
...
class AsyncTargetIndustriesResourceWithRawResponse:
    ...
    def by_dataset(self) -> AsyncByDatasetResourceWithRawResponse:
        return AsyncByDatasetResourceWithRawResponse(self._target_industries.by_dataset)

    @cached_property
    def catalog(self) -> AsyncCatalogResourceWithRawResponse:
        return AsyncCatalogResourceWithRawResponse(self._target_industries.catalog)
...
class TargetIndustriesResourceWithStreamingResponse:
    ...
    def by_dataset(self) -> ByDatasetResourceWithStreamingResponse:
        return ByDatasetResourceWithStreamingResponse(self._target_industries.by_dataset)

    @cached_property
    def catalog(self) -> CatalogResourceWithStreamingResponse:
        return CatalogResourceWithStreamingResponse(self._target_industries.catalog)
...
class AsyncTargetIndustriesResourceWithStreamingResponse:
    ...
    def by_dataset(self) -> AsyncByDatasetResourceWithStreamingResponse:
        return AsyncByDatasetResourceWithStreamingResponse(self._target_industries.by_dataset)

    @cached_property
    def catalog(self) -> AsyncCatalogResourceWithStreamingResponse:
        return AsyncCatalogResourceWithStreamingResponse(self._target_industries.catalog)
