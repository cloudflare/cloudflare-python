...
from ....types.cloudforce_one.threat_events import raw_update_params
from ....types.cloudforce_one.threat_events.raw_get_response import RawGetResponse
from ....types.cloudforce_one.threat_events.raw_update_response import RawUpdateResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                raw_update_params.RawUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RawUpdateResponse,
        )
