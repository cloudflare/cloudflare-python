...
class Downloads(SyncAPIResource):
    ...
    def list(
        self,
        loa_document_identifier: Optional[str],
        *,
        ...
        Args:
          ...
          loa_document_identifier: Identifier for the uploaded LOA document.
        ...
        if not loa_document_identifier:
            raise ValueError(
                f"Expected a non-empty value for `loa_document_identifier` but received {loa_document_identifier!r}"
            )
        return self._get(
            f"/accounts/{account_identifier}/addressing/loa_documents/{loa_document_identifier}/download",
