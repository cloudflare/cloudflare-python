...
from ....types.addresses.address_maps import ZoneUpdateResponse, ZoneDeleteResponse
    ...
    def update(
        ...
        *,
        ...
        return cast(
            Optional[ZoneUpdateResponse],
            self._put(
                f"/accounts/{account_identifier}/addressing/address_maps/{address_map_identifier}/zones/{zone_identifier}",
