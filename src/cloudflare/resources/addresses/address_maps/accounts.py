...
class Accounts(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        Args:
          account_identifier1: Identifier
        ...
        """
        if not account_identifier1:
            raise ValueError(
                f"Expected a non-empty value for `account_identifier1` but received {account_identifier1!r}"
            )
        ...
        return cast(
            Optional[AccountUpdateResponse],
            self._put(
                f"/accounts/{account_identifier1}/addressing/address_maps/{address_map_identifier}/accounts/{account_identifier}",
