...
- <code title="patch /zones/{zone_id}/content-upload-scan/payloads/{expression_id}">client.content_scanning.payloads.<a href="./src/cloudflare/resources/content_scanning/payloads.py">update</a>(expression_id, \*, zone_id, \*\*<a href="src/cloudflare/types/content_scanning/payload_update_params.py">params</a>) -> <a href="./src/cloudflare/types/content_scanning/payload_update_response.py">SyncSinglePage[PayloadUpdateResponse]</a></code>
