...
class ObjectsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncCursorLimitPagination[DurableObject]:
        """
...
class AsyncObjectsResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[DurableObject, AsyncCursorLimitPagination[DurableObject]]:
        """
        Returns the Durable Objects in a given namespace.
