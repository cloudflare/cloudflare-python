...
from ...types.page_shields import ConnectionGetResponse, ConnectionPageShieldListPageShieldConnectionsResponse
...
from ...types.page_shields import connection_page_shield_list_page_shield_connections_params
...
class Connections(SyncAPIResource):
    ...
    def page_shield_list_page_shield_connections(
        self,
        zone_id: str,
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> Optional[ConnectionPageShieldListPageShieldConnectionsResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    connection_page_shield_list_page_shield_connections_params.ConnectionPageShieldListPageShieldConnectionsParams,
                ),
                post_parser=ResultWrapper._unwrapper,
            ),
            cast_to=cast(
                Type[Optional[ConnectionPageShieldListPageShieldConnectionsResponse]],
                ResultWrapper[ConnectionPageShieldListPageShieldConnectionsResponse],
            ),
        )
...
class AsyncConnections(AsyncAPIResource):
    ...
    async def page_shield_list_page_shield_connections(
        self,
        zone_id: str,
        *,
        direction: Literal["asc", "desc"] | NotGiven = NOT_GIVEN,
...
class ConnectionsWithRawResponse:
    def __init__(self, connections: Connections) -> None:
        ...
        self.page_shield_list_page_shield_connections = to_raw_response_wrapper(
            connections.page_shield_list_page_shield_connections,
        )
...
class AsyncConnectionsWithRawResponse:
    def __init__(self, connections: AsyncConnections) -> None:
        ...
        self.page_shield_list_page_shield_connections = async_to_raw_response_wrapper(
            connections.page_shield_list_page_shield_connections,
        )
...
class ConnectionsWithStreamingResponse:
    def __init__(self, connections: Connections) -> None:
        ...
        self.page_shield_list_page_shield_connections = to_streamed_response_wrapper(
            connections.page_shield_list_page_shield_connections,
        )
...
class AsyncConnectionsWithStreamingResponse:
    def __init__(self, connections: AsyncConnections) -> None:
        ...
        self.page_shield_list_page_shield_connections = async_to_streamed_response_wrapper(
            connections.page_shield_list_page_shield_connections,
        )
