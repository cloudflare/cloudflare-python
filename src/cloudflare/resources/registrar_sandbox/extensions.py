...
from ...types.registrar_sandbox import extension_list_params
from ...types.registrar_sandbox.extension_get_response import ExtensionGetResponse
from ...types.registrar_sandbox.extension_list_response import ExtensionListResponse
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            path_template("/accounts/{account_id}/registrar-sandbox/extensions", account_id=account_id),
