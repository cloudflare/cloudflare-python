...
from .by_tag import ByTagResource, AsyncByTagResource, ByTagResourceWithRawResponse, AsyncByTagResourceWithRawResponse, ByTagResourceWithStreamingResponse, AsyncByTagResourceWithStreamingResponse
...
class VersionsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncSinglePage[VersionListResponse]:
        """
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> None:
        ...
        if not ruleset_version:
          raise ValueError(
            f'Expected a non-empty value for `ruleset_version` but received {ruleset_version!r}'
          )
        if account_id and zone_id:
          raise ValueError('You cannot provide both account_id and zone_id');
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> VersionGetResponse:
        """
        ...
        return self._get(
            f"/{account_or_zone}/{account_or_zone_id}/rulesets/{ruleset_id}/versions/{ruleset_version}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[VersionGetResponse]._unwrapper),
...
class AsyncVersionsResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[VersionListResponse, AsyncSinglePage[VersionListResponse]]:
        """
        Fetches the versions of an account or zone ruleset.
