...
from ...types.firewall import rule_create_params, rule_update_params
...
from ...types.firewall import rule_create_params
from ...types.firewall import rule_update_params
from ...types.firewall import rule_list_params
from ...types.firewall import rule_get_params
from ...types.filters import FirewallFilter
from ...types.filters import FirewallFilter
...
class RulesResource(SyncAPIResource):
    ...
    @typing_extensions.deprecated("The Firewall Rules API is deprecated in favour of using the Ruleset Engine. See https://developers.cloudflare.com/fundamentals/api/reference/deprecations/#firewall-rules-api-and-filters-api for full details.")
    def create(self,
    zone_identifier: str,
    *,
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> FirewallRule:
        """
        ...
        return self._put(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[FirewallRule]._unwrapper),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SyncV4PagePaginationArray[FirewallRule]:
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> FirewallRule:
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "id": query_id
            }, rule_get_params.RuleGetParams), post_parser=ResultWrapper[FirewallRule]._unwrapper),
            cast_to=cast(Type[FirewallRule], ResultWrapper[FirewallRule]),
        )
...
class AsyncRulesResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> AsyncPaginator[FirewallRule, AsyncV4PagePaginationArray[FirewallRule]]:
        """Fetches firewall rules in a zone.
