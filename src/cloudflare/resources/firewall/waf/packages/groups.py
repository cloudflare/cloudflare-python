...
from .....types.firewall.waf.packages import GroupUpdateResponse, GroupListResponse, GroupGetResponse
...
from .....types.firewall.waf.packages import group_update_params
