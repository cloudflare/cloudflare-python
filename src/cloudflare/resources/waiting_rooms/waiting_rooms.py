    ...
    def edit(
        ...
        *,
        ...
        return self._patch(
            ...
            cast_to=cast(Type[WaitingRoomEditResponse], ResultWrapper[WaitingRoomEditResponse]),
        )
    ...
    def preview(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=cast(Type[WaitingRoomPreviewResponse], ResultWrapper[WaitingRoomPreviewResponse]),
        )
