    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=cast(Type[WaitingRoomCreateResponse], ResultWrapper[WaitingRoomCreateResponse]),
        )
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            ...
            cast_to=cast(Type[WaitingRoomUpdateResponse], ResultWrapper[WaitingRoomUpdateResponse]),
        )
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=cast(Type[WaitingRoomGetResponse], ResultWrapper[WaitingRoomGetResponse]),
        )
...
class WaitingRoomsWithRawResponse:
    ...
    def previews(self) -> PreviewsWithRawResponse:
        return PreviewsWithRawResponse(self._waiting_rooms.previews)
...
class AsyncWaitingRoomsWithRawResponse:
    ...
    def previews(self) -> AsyncPreviewsWithRawResponse:
        return AsyncPreviewsWithRawResponse(self._waiting_rooms.previews)
...
class WaitingRoomsWithStreamingResponse:
    ...
    def previews(self) -> PreviewsWithStreamingResponse:
        return PreviewsWithStreamingResponse(self._waiting_rooms.previews)
...
class AsyncWaitingRoomsWithStreamingResponse:
    ...
    def previews(self) -> AsyncPreviewsWithStreamingResponse:
        return AsyncPreviewsWithStreamingResponse(self._waiting_rooms.previews)
