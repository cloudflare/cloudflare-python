...
class AccessibilityTreeResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        add_script_tag: Iterable[accessibility_tree_create_params.AddScriptTag] | Omit = omit,
        add_style_tag: Iterable[accessibility_tree_create_params.AddStyleTag] | Omit = omit,
        ...
        | Omit = omit,
        authenticate: accessibility_tree_create_params.Authenticate | Omit = omit,
        best_attempt: bool | Omit = omit,
        cookies: Iterable[accessibility_tree_create_params.Cookie] | Omit = omit,
        emulate_media_type: str | Omit = omit,
        goto_options: accessibility_tree_create_params.GotoOptions | Omit = omit,
        html: str | Omit = omit,
        ...
        viewport: accessibility_tree_create_params.Viewport | Omit = omit,
        wait_for_selector: accessibility_tree_create_params.WaitForSelector | Omit = omit,
