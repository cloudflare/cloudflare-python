...
class ContentResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        cache_ttl: float | Omit = omit,
        action_timeout: float | Omit = omit,
        add_script_tag: Iterable[content_create_params.Variant0AddScriptTag]
        | Iterable[content_create_params.Variant1AddScriptTag]
        | Omit = omit,
        add_style_tag: Iterable[content_create_params.Variant0AddStyleTag]
        | Iterable[content_create_params.Variant1AddStyleTag]
        | Omit = omit,
        allow_request_pattern: SequenceNotStr[str] | Omit = omit,
        allow_resource_types: List[
            Literal[
        ...
        | Omit = omit,
        authenticate: content_create_params.Variant0Authenticate
        | content_create_params.Variant1Authenticate
        | Omit = omit,
        best_attempt: bool | Omit = omit,
        cookies: Iterable[content_create_params.Variant0Cookie]
        | Iterable[content_create_params.Variant1Cookie]
        | Omit = omit,
        emulate_media_type: str | Omit = omit,
        goto_options: content_create_params.Variant0GotoOptions
        | content_create_params.Variant1GotoOptions
        | Omit = omit,
        reject_request_pattern: SequenceNotStr[str] | Omit = omit,
        reject_resource_types: List[
            Literal[
        ...
        set_java_script_enabled: bool | Omit = omit,
        user_agent: str | Omit = omit,
        viewport: content_create_params.Variant0Viewport | content_create_params.Variant1Viewport | Omit = omit,
        wait_for_selector: content_create_params.Variant0WaitForSelector
        | content_create_params.Variant1WaitForSelector
        | Omit = omit,
        wait_for_timeout: float | Omit = omit,
        html: str | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
