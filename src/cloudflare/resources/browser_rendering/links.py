...
class LinksResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        add_script_tag: Iterable[link_create_params.Variant0AddScriptTag] | Omit = omit,
        add_style_tag: Iterable[link_create_params.Variant0AddStyleTag] | Omit = omit,
        ...
        | Omit = omit,
        authenticate: link_create_params.Variant0Authenticate | Omit = omit,
        best_attempt: bool | Omit = omit,
        cookies: Iterable[link_create_params.Variant0Cookie] | Omit = omit,
        emulate_media_type: str | Omit = omit,
        exclude_external_links: bool | Omit = omit,
        goto_options: link_create_params.Variant0GotoOptions | Omit = omit,
        ...
        viewport: link_create_params.Variant0Viewport | Omit = omit,
        visible_links_only: bool | Omit = omit,
        wait_for_selector: link_create_params.Variant0WaitForSelector | Omit = omit,
    ...
    def create(
        ...
        *,
        ...
        cache_ttl: float | Omit = omit,
        action_timeout: float | Omit = omit,
        add_script_tag: Iterable[link_create_params.Variant1AddScriptTag] | Omit = omit,
        add_style_tag: Iterable[link_create_params.Variant1AddStyleTag] | Omit = omit,
        allow_request_pattern: SequenceNotStr[str] | Omit = omit,
        allow_resource_types: List[
            Literal[
                "document",
        ...
        | Omit = omit,
        authenticate: link_create_params.Variant1Authenticate | Omit = omit,
        best_attempt: bool | Omit = omit,
        cookies: Iterable[link_create_params.Variant1Cookie] | Omit = omit,
        emulate_media_type: str | Omit = omit,
        exclude_external_links: bool | Omit = omit,
        goto_options: link_create_params.Variant1GotoOptions | Omit = omit,
        reject_request_pattern: SequenceNotStr[str] | Omit = omit,
        reject_resource_types: List[
            Literal[
                "document",
        ...
        set_java_script_enabled: bool | Omit = omit,
        user_agent: str | Omit = omit,
        viewport: link_create_params.Variant1Viewport | Omit = omit,
        visible_links_only: bool | Omit = omit,
        wait_for_selector: link_create_params.Variant1WaitForSelector | Omit = omit,
        wait_for_timeout: float | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
    ...
    def create(
        ...
        *,
        ...
        cache_ttl: float | Omit = omit,
        action_timeout: float | Omit = omit,
        add_script_tag: Iterable[link_create_params.Variant0AddScriptTag]
        | Iterable[link_create_params.Variant1AddScriptTag]
        | Omit = omit,
        add_style_tag: Iterable[link_create_params.Variant0AddStyleTag]
        | Iterable[link_create_params.Variant1AddStyleTag]
        | Omit = omit,
        allow_request_pattern: SequenceNotStr[str] | Omit = omit,
        allow_resource_types: List[
            Literal[
        ...
        | Omit = omit,
        authenticate: link_create_params.Variant0Authenticate | link_create_params.Variant1Authenticate | Omit = omit,
        best_attempt: bool | Omit = omit,
        cookies: Iterable[link_create_params.Variant0Cookie]
        | Iterable[link_create_params.Variant1Cookie]
        | Omit = omit,
        emulate_media_type: str | Omit = omit,
        exclude_external_links: bool | Omit = omit,
        goto_options: link_create_params.Variant0GotoOptions | link_create_params.Variant1GotoOptions | Omit = omit,
        reject_request_pattern: SequenceNotStr[str] | Omit = omit,
        reject_resource_types: List[
            Literal[
                "document",
        ...
        set_java_script_enabled: bool | Omit = omit,
        user_agent: str | Omit = omit,
        viewport: link_create_params.Variant0Viewport | link_create_params.Variant1Viewport | Omit = omit,
        visible_links_only: bool | Omit = omit,
        wait_for_selector: link_create_params.Variant0WaitForSelector
        | link_create_params.Variant1WaitForSelector
        | Omit = omit,
        wait_for_timeout: float | Omit = omit,
        url: str | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
