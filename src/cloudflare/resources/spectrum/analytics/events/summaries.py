...
class SummariesResource(SyncAPIResource):
    ...
    *,
    ...
    metrics: List[Literal["count", "bytesIngress", "bytesEgress", "durationAvg", "durationMedian", "duration90th", "duration99th"]] | NotGiven = NOT_GIVEN,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[SummaryGetResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "sort": sort,
                "until": until,
            }, summary_get_params.SummaryGetParams), post_parser=ResultWrapper[Optional[SummaryGetResponse]]._unwrapper),
