...
class BytimesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[BytimeGetResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                ...
                "sort": sort,
                "until": until,
            }, bytime_get_params.BytimeGetParams), post_parser=ResultWrapper[Optional[BytimeGetResponse]]._unwrapper),
