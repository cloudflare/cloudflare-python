...
- <code title="delete /{accounts_or_zones}/{account_or_zone_id}/logs/explorer/datasets/{dataset_id}">client.logs.log_explorer.datasets.<a href="./src/cloudflare/resources/logs/log_explorer/datasets/datasets.py">delete</a>(dataset_id, \*, account_id, zone_id) -> <a href="./src/cloudflare/types/logs/log_explorer/dataset.py">Optional[Dataset]</a></code>
