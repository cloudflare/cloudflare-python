...
from ...types.user import subscription_update_params, subscription_edit_params
...
from ...types.user import subscription_edit_params
...
class SubscriptionsResource(SyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SubscriptionEditResponse:
        """
        ...
        return cast(SubscriptionEditResponse, self._put(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[SubscriptionEditResponse]._unwrapper),
            cast_to=cast(Any, ResultWrapper[SubscriptionEditResponse]),  # Union types cannot be passed in as arguments in the type system
        ))
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[SubscriptionGetResponse]:
        """Lists all of a user's subscriptions."""
        return self._get(
            "/user/subscriptions",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[SubscriptionGetResponse]]._unwrapper),
...
class AsyncSubscriptionsResource(AsyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> SubscriptionEditResponse:
        ...
        return cast(SubscriptionEditResponse, await self._put(
            f"/zones/{identifier}/subscription",
            body=await async_maybe_transform({
                "app": app,
                "component_values": component_values,
