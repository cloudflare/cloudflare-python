...
from .cookies import CookiesResource, AsyncCookiesResource, CookiesResourceWithRawResponse, AsyncCookiesResourceWithRawResponse, CookiesResourceWithStreamingResponse, AsyncCookiesResourceWithStreamingResponse
...
class PageShieldResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[PageShieldUpdateResponse]:
        """
        ...
        return self._put(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, post_parser=ResultWrapper[Optional[PageShieldUpdateResponse]]._unwrapper),
