...
from ....types.ddos_protection.advanced_tcp_protection import status_edit_params
from ....types.ddos_protection.advanced_tcp_protection.status_get_response import StatusGetResponse
from ....types.ddos_protection.advanced_tcp_protection.status_edit_response import StatusEditResponse
    ...
    def edit(
        ...
        *,
        ...
        Args:
          ...
          enabled: Enables or disables protection.
        ...
        return self._patch(
            ...
            body=maybe_transform({"enabled": enabled}, status_edit_params.StatusEditParams),
    ...
    async def edit(
        ...
        *,
        ...
        return await self._patch(
            ...
            body=await async_maybe_transform({"enabled": enabled}, status_edit_params.StatusEditParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
