...
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.filters import item_edit_params
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.filters.item_get_response import (
    ItemGetResponse,
)
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.filters.item_edit_response import (
    ItemEditResponse,
)
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.filters.item_delete_response import (
    ItemDeleteResponse,
)
    ...
    def edit(
        ...
        *,
        ...
        Args:
          ...
          mode: The new mode for the filter. Optional. Must be one of 'enabled', 'disabled',
              'monitoring'.
