...
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.rules import item_edit_params
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.rules.item_get_response import (
    ItemGetResponse,
)
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.rules.item_edit_response import (
    ItemEditResponse,
)
from ......types.ddos_protection.advanced_tcp_protection.tcp_flow_protection.rules.item_delete_response import (
    ItemDeleteResponse,
)
    ...
    def edit(
        ...
        *,
        ...
        Args:
          ...
          mode: The new mode for TCP Flow Protection. Optional. Must be one of 'enabled',
              'disabled', 'monitoring'.
