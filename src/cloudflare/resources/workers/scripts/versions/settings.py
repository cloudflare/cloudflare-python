...
from .....types.workers.scripts.versions import Settings, SettingsParam, settings, setting_edit_params
    ...
    def edit(
        ...
        *,
        ...
        return self._patch(
            ...
            cast_to=cast(Type[settings.Settings], ResultWrapper[settings.Settings]),
        )
