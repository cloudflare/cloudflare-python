...
from .....types.workers.deployments import ByScriptWorkerDeploymentsListDeploymentsResponse
...
class ByScripts(SyncAPIResource):
    ...
    def worker_deployments_list_deployments(
        self,
        script_id: str,
        *,
        account_id: str,
    ...
    ) -> ByScriptWorkerDeploymentsListDeploymentsResponse:
        """
        List Deployments
        ...
        return self._get(
            ...
            cast_to=cast(
                Type[ByScriptWorkerDeploymentsListDeploymentsResponse],
                ResultWrapper[ByScriptWorkerDeploymentsListDeploymentsResponse],
            ),
        )
...
class AsyncByScripts(AsyncAPIResource):
    ...
    async def worker_deployments_list_deployments(
        self,
        script_id: str,
        *,
        account_id: str,
...
class ByScriptsWithRawResponse:
    def __init__(self, by_scripts: ByScripts) -> None:
        ...
        self.worker_deployments_list_deployments = to_raw_response_wrapper(
            by_scripts.worker_deployments_list_deployments,
        )
...
class AsyncByScriptsWithRawResponse:
    def __init__(self, by_scripts: AsyncByScripts) -> None:
        ...
        self.worker_deployments_list_deployments = async_to_raw_response_wrapper(
            by_scripts.worker_deployments_list_deployments,
        )
...
class ByScriptsWithStreamingResponse:
    def __init__(self, by_scripts: ByScripts) -> None:
        ...
        self.worker_deployments_list_deployments = to_streamed_response_wrapper(
            by_scripts.worker_deployments_list_deployments,
        )
...
class AsyncByScriptsWithStreamingResponse:
    def __init__(self, by_scripts: AsyncByScripts) -> None:
        ...
        self.worker_deployments_list_deployments = async_to_streamed_response_wrapper(
            by_scripts.worker_deployments_list_deployments,
        )
