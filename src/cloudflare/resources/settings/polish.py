...
from ...types.settings import PolishUpdateResponse, PolishGetResponse, polish_update_params
...
from ...types.settings import polish_update_params
...
class Polish(SyncAPIResource):
    ...
    def update(
        ...
        zone_id: str,
        *,
        value: polish_update_params.Value,
        ...
        return self._patch(
            ...
            body=maybe_transform({"value": value}, polish_update_params.PolishUpdateParams),
            ...
            cast_to=cast(Type[Optional[PolishUpdateResponse]], ResultWrapper[PolishUpdateResponse]),
        )
