...
class VideosResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,) -> Optional[VideoStorageUsageResponse]:
        """
        ...
        return self._get(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "creator": creator
            }, video_storage_usage_params.VideoStorageUsageParams), post_parser=ResultWrapper[Optional[VideoStorageUsageResponse]]._unwrapper),
