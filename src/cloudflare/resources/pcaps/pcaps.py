...
class Pcaps(SyncAPIResource):
    ...
    def magic_pcap_collection_create_pcap_request(
        ...
        *,
        ...
        filter_v1: pcap_magic_pcap_collection_create_pcap_request_params.Y652Sr8cPcapsRequestSimpleFilterV1
        | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
    ...
    def magic_pcap_collection_create_pcap_request(
        ...
        *,
        ...
        filter_v1: pcap_magic_pcap_collection_create_pcap_request_params.Y652Sr8cPcapsRequestFullFilterV1
        | NotGiven = NOT_GIVEN,
